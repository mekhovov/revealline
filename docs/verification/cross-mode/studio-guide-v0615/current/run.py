...
before=inputs(); ident=identity(); assert ident['branch']=='codex/p03-studio-guide-v0615'; initial=budget(); argv=[node,'--max-old-space-size=1024','--test','--test-concurrency=1',*tests]
