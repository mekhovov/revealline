...
def pins():
 ...
 return rows
before=pins(); results=[]
(C/'focused-inputs-before-02.json').write_text(json.dumps(before,indent=2)+'\n')
for version in ['22.22.2','20.19.5']:
 ...
 log=C/f'whole-node{version.split(".")[0]}-02.log'
