...
import { couchPage } from 'file:///Users/oleksandr.mekhovov/work/my_projects/go_test/.cache/worktrees/p08-versus-footprint/game/test/helpers/couch-host.mjs';
import { inspectImageDataUrl } from 'file:///Users/oleksandr.mekhovov/work/my_projects/go_test/.cache/worktrees/p08-versus-footprint/game/content.mjs';
import { waitFor } from 'file:///Users/oleksandr.mekhovov/work/my_projects/go_test/.cache/worktrees/p08-versus-footprint/game/test/helpers/wait-for.mjs';
...
test('actual Versus fallback refits both boards before drawing a changed encounter hint without ResizeObserver', async (t) => {
  const pack = JSON.parse(await readFile(new URL('file:///Users/oleksandr.mekhovov/work/my_projects/go_test/.cache/worktrees/p08-versus-footprint/game/content/packs/sentinel-relay.json', import.meta.url), 'utf8'));
  let geometryReads = 0;
  const { page, rendering } = await fixture(t, {
