...
NORMAL_BINDING_SHA256 = 'a4b2ef449ebc174b7bc25968f3d3a57c70fe1645caab7ad74d2f22ab2a225d7d'
LIMIT = 64 * 1024 * 1024
...
binding = {'base': BASE, 'baseTree': tree, 'sourceHoldSha256': HOLD,
           'overlays': [rows[name] for name in overlays], 'compositionTree': held['tree'], 'parents': held['parents'],
           ...
           'scope': 'Exact Gitfcc4032 with the same fourteen immutable b1e8d58a production overlays as normal50512: P05-B/P08 static composition and Team pause-slot spacing. The only timing fixture waits six seconds before headers/body for every GET of the one exact original c1aedf89 PNG, including ranges; HEAD is immediate. Original bytes and application clocks/state are unchanged. No scripted responses or later P03 operation-focus/row, Team picture, new P02/P01 history. Normal50512 remains unchanged. Finished-to-Next prior-result preservation remains P07. LRU bounds stored Git blobs, not total RSS.'}
