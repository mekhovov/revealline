...
args=['/Users/oleksandr.mekhovov/.local/share/mise/installs/node/20.19.5/bin/agent-browser','--config',str(folder/'agent-browser.json'),'--session','p01-craft-focus-clearance',*sys.argv[1:]]
