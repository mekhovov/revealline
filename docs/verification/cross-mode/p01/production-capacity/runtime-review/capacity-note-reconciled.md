...
The isolated proposal reproduces four boundary failures in the original and passes ten checks after correction. The source correction is now applied with ASCII scalar accounting; actual production-history/boundary tests are running. Independent static review found no blocker. Complete new-commit qualification remains pending. No public or phase acceptance follows from this proposal.
