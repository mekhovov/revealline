...
HOLD = '65da87662c33691a9c4c0f4d839c6d283bb888fbbd50e67b4de5509339b26d6e'
LIMIT = 64 * 1024 * 1024
...
binding = {'base': BASE, 'baseTree': tree, 'sourceHoldSha256': HOLD,
           'overlays': [rows[name] for name in overlays], 'candidateMenuSource': True,
           ...
           'scope': 'Exact Git3f934b7 P05-A baseline with eleven immutable P05-B menu production overlays pinned at source-held-02 (only CSS gutter successor differs in served production). All other regular assets come from that Git commit. New independent origin; no browser/native closure or existing profile reused. No state injection, scripted responses, delay fixture, P08, or subsequent P03 operation-focus correction. This source binding is not native or phase acceptance. Large is a preset, not browser zoom. LRU cap describes stored Git blobs, not total RSS.'}
