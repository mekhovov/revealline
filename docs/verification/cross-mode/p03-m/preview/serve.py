...
BASE = '5aceb1b34764822e12303489494bd6b91e23516e'
HOLD = '95a24984e3222170c80e653ad36ccc76e6b65cb0d6cfeb858d643aa09056de49'
LIMIT = 64 * 1024 * 1024
if shutil.disk_usage(OUT).free < 256 * 1024 * 1024:
    raise RuntimeError('Insufficient metadata reserve')
raw = (OUT.parent / 'source-held-03.json').read_bytes()
...
overlays = {}
for name in ('game/app.mjs', 'game/index.html', 'game/ui/game-shell.mjs', 'game/ui/modal-navigation.mjs', 'game/ui/mode-choice.mjs', 'game/ui/mode-choice.css'):
...
binding = {'base': BASE, 'baseTree': tree, 'sourceHoldSha256': HOLD,
           'overlays': [rows[name] for name in overlays], 'sharedDependencyCommit': held['dependencyCommit'],
           ...
           'scope': 'Exact Git5ace with four owned production and two L presenter immutable memory overlays pinned at held03. Other regular assets come from Git5ace, including historical Couch modules; no state/responses/timing fixtures, P05/P08 or successor Couch L/R5 overlays. LRU cap describes stored Git blobs, not total process RSS.'}
