...
Evidence snapshot: 2026-09-13. **v0.26.0 is frozen, audited and published as a GitHub Release; v0.27 changes are undergoing qualification in source.** v0.26 Pages deployment and public byte/browser checks have passed. A source-browser success is not evidence that those new changes have reached the public site.
