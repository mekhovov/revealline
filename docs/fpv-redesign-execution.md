...
| 3     | Local asset studio, sprite editor, previews, prompts and bundle exchange                  | In progress                             | Working local UI; browser edit/validation/undo/save/reload passed; release pending     |
