...
| P10 | 0.78.0 | Crosswind Array and Remix | Isolated directional Map/Mission V3 and runtime/replay successor; one fixed player-only with/against/across recipe, no drift, marked-field-only activation. Shared compiler/transport, static cues and copy-on-write Studio controls.54 core/relay,18 authoring/transport,82 shell and31 lifecycle cohort tests pass on Node20/22; all59 earlier routes unchanged. Scoped native opt-in/edit/rejection/Undo/Redo/reload and island capture verified, including immediate arrow neutralization. Whole-set readability, content/art, Team, human and release gates remain |
| P11–P12 | 0.79.0–0.80.0 | Campaigns 11–12, each with Remix/assets/mode qualification | Pending |
