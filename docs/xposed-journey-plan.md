...
| P11 | 0.79.0 | Sentinel Crown and Remix | Isolated explicit multi-shield encounter successor; 63/63 core/regression tests pass on Node20/22, including legal two-relay clears, replay, persistence, life recovery and clock windows. Shared authoring, candidate content, presentation, mode qualification, human and release gates remain; see P11 verification record |
