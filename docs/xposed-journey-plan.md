...
| P05 | 0.73.0 | Rover Yard and Remix | Draft PR192: explicit v2 roamer catalogue, seven original greyboxes,42 replay-verified Solo clears and42 equal paired races, all42 optional-goal combinations,320 seed checks and35 delayed-start alternatives. Shared Studio/CLI, six reference adaptations, native Studio/one first return checked. Art, broader native/human and release gates remain |
