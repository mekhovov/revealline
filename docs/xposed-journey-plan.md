...
| P11 | 0.79.0 | Sentinel Crown and Remix | Isolated multi-shield successor, shared recipe/compiler/transport and atomic Studio controls; 122/122 regression tests on Node20/22. Four core greyboxes plus optional Remix and three reference proposals; 17/17 candidate/readiness tests on both Nodes. Full-route qualification is in progress; short optimized clears keep two layouts provisional. Final presentation, modes, human pacing and release gates remain; see P11 verification record |
| P12 | 0.80.0 | Apex Aurora and Remix | Pending |
