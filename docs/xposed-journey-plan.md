...
| P14 | 0.82.0 | Complete 12 Team missions and two-player balance | Local preparation: eight-mission review source preserves existing editions across two four-mission learning arcs. Three new foundation and three material greyboxes have continuous-steering clear/mastery routes with joint cuts on/off and swapped seats. Material routes add90 seed cases and15 Standard delayed alternatives; real Team host clears each three-mission campaign per preset with one Next. Explicit Studio inspection and exact campaign test export added. Four further candidates, reclaimed-roamer qualification, broader native/human, art, cross-campaign Team Journey navigation and publication gates remain; see P14 verification record |
