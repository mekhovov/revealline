...
| P11 | 0.79.0 | Sentinel Crown and Remix | Isolated multi-shield encounter successor, fixed shared catalog recipe, compiler/transport, read-only shield cues and atomic Studio controls.122/122 core/compiler/transport/Studio regressions pass on Node20/22, including legal two-relay clears, replay, persistence and clock windows. Candidate content, final presentation, mode qualification, native/human and release gates remain; see P11 verification record |
