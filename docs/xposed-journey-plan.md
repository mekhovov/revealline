...
| P05 | 0.73.0 | Rover Yard and Remix | Draft PR192: explicit v2 roamer catalogue, seven original greyboxes,42 replay-verified no-loss Solo routes and42 equal paired races; shared Studio/CLI previews and six reference adaptations. Two dormant-only teaching gaps revised. Optional-goal/timing alternatives, art, native/human and release gates remain |
