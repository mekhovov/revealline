...
| P10 | 0.78.0 | Crosswind Array and Remix | Isolated directional Map/Mission V3 and runtime/replay successor; one fixed player-only with/against/across recipe, no drift, marked-field-only activation. Shared geometry/compiler, exact boundary/buffered-turn integration and checkpoint tests;54 core/relay regression tests pass on Node20/22. Transport, readable Studio/runtime cues, content/art, Team, human and release gates remain |
