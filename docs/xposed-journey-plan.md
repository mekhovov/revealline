...
| P11 | 0.79.0 | Sentinel Crown and Remix | Isolated multi-shield successor, shared compiler/transport and atomic Studio controls; 122/122 regression tests on Node20/22. Four core greyboxes plus optional Remix and three reference proposals. All30 prepared Solo/replay and equal paired races plus150 seed samples pass; route/cue/evidence cohort42/42 on both Nodes. Native first capture checked. Mastery/delays in progress; short optimized clears keep two layouts provisional. Art, Team, human and publication gates remain; see P11 verification record |
