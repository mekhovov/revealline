...
| P12 | 0.80.0 | Apex Aurora and Remix | Isolated four-mission capstone arc plus optional Remix; three reference finales reinspected. No new rules or speed overrides. All30 bonus-independent prepared Solo/public-replay and equal paired-board clears,150 seed and32 restored-session samples pass Node20/22, plus opening/compiler parity. Empty inner chamber and unused-dock route rejected. Scoped native import/closure/three-shield briefing checked; emitter naming corrected. Mastery/delay, pacing, art/offline capacity, Team, broader native/human and publication gates remain |
