...
| P06 | 0.74.0 | Fractured Grid and Remix | Independent source preparation: explicit v3 eroder catalogue, shared authoring/chooser silhouettes and replay-verified erosion/repair contract; authored campaign, art, mode and release gates pending |
| P07–P12 | 0.75.0–0.80.0 | Campaigns 7–12, each with Remix/assets/mode qualification | Pending |
