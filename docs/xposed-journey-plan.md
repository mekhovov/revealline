...
| P09 | 0.77.0 | Relay Labyrinth and Remix | Isolated explicit relay editions, shared capture/dependency inspection, transport, linked visual cues and copy-on-write Studio CRUD. Seven greyboxes in two learning arcs plus optional Remix; 42 first-return cases and exact CLI/Studio parity verified. Cohorts112/92/64/59 plus lifecycle45/presentation51/content24 pass on Node20/22; all59 historical routes unchanged. Scoped native CRUD/open/reset verified. Full-route qualification, content/art, broader native/human, Team and release gates remain; excluded from frozen v0.76 |
| P10–P12 | 0.78.0–0.80.0 | Campaigns 10–12, each with Remix/assets/mode qualification | Pending |
