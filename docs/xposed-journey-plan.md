...
| P09 | 0.77.0 | Relay Labyrinth and Remix | Isolated explicit relay map/mission/runtime/replay editions, shared capture/dependency inspection, playable transport and copy-on-write Studio relay CRUD. Cohorts112/92/64/59 pass on Node20/22; all59 historical route checkpoints unchanged. Scoped native create/reject/Undo/Redo/reload/open/reset verified. Campaign content/art, broader native/human, mode and release gates remain; excluded from frozen v0.76 |
