...
| P10 | 0.78.0 | Crosswind Array and Remix | Isolated directional Map/Mission V3 and runtime/replay successor; one fixed player-only with/against/across recipe, no drift, marked-field-only activation. Shared geometry/compiler, exact boundary/buffered-turn integration, checkpoint authority, scenario/pack transport, static directional cues and copy-on-write Studio controls.54 core/relay,18 authoring/transport and82 shell regression tests pass on Node20/22; all59 earlier routes unchanged. Native readability, content/art, Team, human and release gates remain |
