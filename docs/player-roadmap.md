...
- Hidden artwork is opaque black. Winning grants the complete picture without changing recorded coverage, followed by an optional skippable story. The lobby teaser conceals the centre; metadata-only library cards stay artwork-lazy, and their explicit full picture preview must not complete a mission, earn a picture or change progress.
