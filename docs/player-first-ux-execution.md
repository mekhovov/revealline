...
selector and public player-flow acceptance remain open, so the public baseline
remains v0.141.2.

**Ordered continuation:** v0.141.3 is merged source; later rows remain working
...
The current order starts with merged v0.141.3 Team quick start, then v0.141.4 Couch secondary
...
promoted. v0.110.1 advances the two approved Team picture bindings and historical
import policy to exact revision 74, retains revisions 58–73, and raises the finite
policy bound by one. M3–M4 and UX1–UX6 remain unfinished.** The former
...
The combined UX1-A draft adds real Solo, Versus and Team host admission without
...
gameplay clear but cannot claim a picture. Solo Collection and the bounded Couch
Journey Pictures dialogs use exact-edition filtering and restore their openers; the
full shared Collection/gallery redesign remains UX1-B/UX5. This is draft source
evidence only and remains dependent on final gates and public release.
