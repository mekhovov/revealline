...
| P03   | A–M/A1/A2/R3/R5 and operation focus through `d0925c0`; 767-check composed coverage and separate native journeys recorded.                          | Recreated pack rows, Score/Collection paging focus, accepted P01/P02 integration, full source/build/public/offline and physical-input qualification. |
| P05   | P05-A `3f934b7` and P05-B `fcc4032`: shared text/effects preferences, menu palettes/ornaments and corrected label gutters.                         | Compose current sources, fix Team pause-row spacing, finish responsive/zoom, contrast, preference failure and actual-device checks.                  |
| P08-A | Static composition `1817377` on P05-A: scoped Solo/Versus picture parity, cancellation and focus checks. Team painter/lease `e5b2b91` is separate. | Team host/artwork adoption, complete actor/edition/import parity, all actual-size arena identities and final public/device qualification.            |
