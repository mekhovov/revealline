...
| P18-COMPACT-TRACK | Reconciled contract; implementation queued | Keep an identifiable current-track control and complete title/artist/filename/source details in Pause/Music without changing arena size mid-cut. [Contract and research](compact-gameplay-music.md). | Actual host metadata/navigation tests, readable responsive layout, device and publication gates after PR209. |
