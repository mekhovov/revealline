...
| P03   | A–M/A1/A2/R3/R5 and operation focus through `d0925c0`; row focus `9d43ca9`, pager focus `0368f58f` and gallery return `7fedeef` are composed over `ec288a4e` in the current internal candidate. Couch focus/reveal `2c61981b` and its documentation successor `90e8bc81` remain separate. | Finish exact-source integration with the accepted P01/P02 and separate Couch candidates, then full source/build/public/offline and physical-input qualification.                                       |
| P05   | P05-A `3f934b7`, P05-B `fcc4032` and static composition `063ff5d6` include shared text/effects preferences, menu palettes/ornaments, label gutters and the scoped Team pause-row spacing correction.                                                                                  | Integrate the current candidates; finish responsive/zoom, contrast, preference-failure and actual-device checks.                                                                                       |
| P08-A | Static composition `063ff5d6` combines the reviewed P05 menu and Solo/Versus picture work. Separate Team host `d3ff0bc1` adopts the two canonical original-image bindings and painter/lease with scoped loading, partial-reveal and paused-state checks.                              | Compose the Team host with the final current sources; complete actor/edition/import parity, full Team completion/rescue journeys, all required arena identities and final public/device qualification. |

These identities describe separate internal source checkpoints and their scoped evidence. The current P03 row/pager/gallery composition does not adopt the separate P05/static/Couch/Team branches; test totals and browser observations are not added across candidates. Its [combined Library evidence](verification/cross-mode/p03-pager-gallery-integration/README.md) records 201/201 on each Node runtime and nine native keyboard observations, with the incomplete predecessor and fixture correction retained separately.
