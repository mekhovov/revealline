...
6. Choose **UA-FPV · Local volume 01**, **02**, **03**, or **04** in the playback playlist selector and click **Save & use playlist**. Turn sound on and press **Play music** if it is paused. Browser audio may need this first explicit gesture.
...
After all four volumes are saved, choose **Ukrainian** in **Music selection**, then **Save & use music selection**. This clears the explicit playback-playlist choice and gives a repeating shuffled selection of eligible Ukrainian-tagged tracks, including the imported UA-FPV collection. These local tracks are tagged for both menu and gameplay. Selecting a genre is not a review of the recordings' cultural accuracy or rights.
...
- Importing all four volumes needs **80 of 123 custom track slots** and **4 of 26 custom playlist slots**, leaving 43 and 22 respectively in an otherwise empty library. Trusted built-in catalogue entries have a separate capacity.
