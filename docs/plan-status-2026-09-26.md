...
- Latest GitHub release: **v0.141.2**, published from source
  `12978e5fd3fe0ce70bbee96aa543f569f64622d4` on 26 September 2026. Current `main` is
  `7509d790dadb6194d70a5bc1efafee40fbb0b3b7`, the merged Team quick-start source labelled
  `0.141.3`; no v0.141.3 GitHub release is claimed here. This lane did not repeat the frozen
  v0.141.2 public play journey.
- The published v0.141.2 creator/community/media source and merged v0.141.3 Team quick-start source
  are now the base for the cultural stack. Their creator, upload, localization, media, compact
  layout, quick-start and publication files are preserved; no draft cultural version may downgrade
  them.
- Test-only PR #669 is superseded by PR #590's broader accepted clock/rearm fixture. The earlier
  ...
  rerun.
- The cultural/pacing successor chain through draft PR #672/v32 and performance successor PR #676
  has been replayed onto current `main`. All **106** stack commits and all **28** stacked branch tips
  ...
  `869934b76831c618f8410a918b22bf1df44dad6a` passes **107/107** selector/library checks and
  **109/109** Team quick-start integration checks with zero skips. Repository validation passes for
  10,175 localized messages, 8,029 references and 1,272 files. All 28 remote tips were replaced
  atomically with exact old-head leases; PRs #650, #651, #661, #664-#667, #670-#672 and #676
  resolve cleanly against their intended predecessors. Independent PR #657 is separately rebased
  onto current `main` at `e210dab767a6bafe467fd86f516730278e502bb0`; its 33/33 focused cohort
  passes with zero skips. The dirty root checkout was not changed.
...
v0.141.3 Team quick-start rebase. The exact combined top instead has fresh 107/107 selector and
109/109 Team quick-start integration evidence.
...
Versions through v0.141.2 are occupied by published releases; merged `main` currently labels the
Team quick-start successor `0.141.3` without a corresponding GitHub release claim here. Cultural
draft labels do not reserve a release number; the sole publisher assigns versions from the accepted
...
6. **Disk pressure:** only reviewed disposable build caches were removed; worktrees, releases, media,
   ...
   is only about 0.5 GiB. Avoid duplicate production archives and never remove unpushed source, user
