...
- Latest GitHub release: **v0.141.3**, published from source
  ...
  `65bdcd9825e9e6129bb8e039c3c8922615642689` with package version `0.141.4` and the merged Couch
  navigation/community-acceptance source from PR #683. At the time of this update, GitHub still
  lists v0.141.3 as the latest immutable release and PR #684 owns the pre-freeze Team continuation
  correction. This lane does not claim v0.141.4 as public delivery.
...
- The cultural/pacing successor chain through draft PR #672/v32, performance successor PR #676 and
  accessibility successor PR #685 has been replayed onto current `main`. All **112** stack commits
  and all **29** stacked branch tips
  ...
  game tree `24d9302dccc38c8b0268cbcad755828273ad1c8b` passes **100/100** selector/library checks,
  **8/8** actual controller-host checks and **14/14** observer checks with zero skips. The wider
  109-case Team quick-start and repository-validation cohorts remain prior-base evidence and are not
  relabelled as v0.141.4 passes. Range-diff is one-to-one except for the expected first cultural
  version transition from upstream `0.141.4` to `0.142.0`. All 29 remote tips were replaced
  atomically with exact old-head leases. Independent PR #657 is superseded for the active release by
  PR #684 rather than being rebased a third time. The dirty root checkout was not changed.
...
|        3 | Team continuation and qualification     | Finish PR #684 and the v0.141.4 immutable release; PR #657 is superseded. Paired-board fairness, controller/touch/keyboard, cross-campaign Next, Skip, reload/Continue and public frozen-build proof remain separate evidence                                                                                                                                                                                                                    |                                **6–12 hours** plus release queue/device access |
...
3. Allow the sole publisher to finish PR #684 and v0.141.4. Do not separately merge superseded
   PR #657 into the release line.
...
6. Review PR #685, the v40 selector-accessibility/measurement successor, after PR #676. Collect frozen-build
