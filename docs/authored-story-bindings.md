...
**Historical model-stage specification.** Ordinary-host adoption subsequently landed; see [Story runtime adoption](story-runtime-adoption.md) for those boundaries and [Delivery priorities](delivery-priorities.md) for remaining authoring, transfer and content acceptance. Statements below that hosts or playback are unadopted describe the original isolated stage.
