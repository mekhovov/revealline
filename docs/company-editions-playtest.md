...
- Mission duration targets range from 40–180 seconds for opening maps to 70–240 seconds for later encounters; these are authoring targets, not observed human completion times. The advanced successor's 414 machine routes pass independent replay verification for one seed across three difficulties and two steering policies. Passing traces prove reachability, not usability or pacing.
