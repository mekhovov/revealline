...
- The shared-screen presentation successor advances the current FPV theme to revision 79. Team's two immutable starter-picture associations and the bounded historical-import policy advance to that exact revision while revision 78 joins the retained 58–78 set; picture bytes and content identities do not change.
