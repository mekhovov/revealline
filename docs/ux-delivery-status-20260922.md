...
3. Recover closed PR233 retained-presentation work once, preserving PR252 and session-only originals. This candidate's [130-check-per-runtime focused integration and same-origin native v5 backup/restore evidence](verification/presentation-recovery-20260922/README.md) is separate from full-source, fresh-origin media transfer and public acceptance.
