...
- **Completed:** immutable
  ...
  v0.141.0.
- **Merged next source:** [PR #679](https://github.com/mekhovov/revealline/pull/679)
  merged v0.141.3 Team quick-start as
  `7509d790dadb6194d70a5bc1efafee40fbb0b3b7`. Its immutable release, Pages
  selector and public player-flow acceptance remain open, so v0.141.2 is still
  the public baseline.
...
- **Remaining:** UX6 cumulative Solo/Versus/Team journeys, real-browser viewport,
  ...
  gates. The merged Team quick-start source does not yet claim a release,
