...
| --- | --- | --- | --- |
| 1 | Baseline reconciliation | Preserve working tree/history, integrate reviewed work and finish already qualifying releases. | v0.60.4 accepted; Motion qualifying separately. |
| 2 | P03/P05 Settings and sound | Shared categories, quick mute, immediate global appearance, safe pause/return and storage reconciliation. | Implementing; source/browser/release gates tracked below. |
