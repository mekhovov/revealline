...
The preserved v0.9.0 source supplies 28 maps, seven gameplay roles, four presentation themes, five installable expansions and six effective optional equipment goals. Equipment Workshop adds three themed examples of [pack-authored goals](pack-mastery-contract.md); Homeward Skies retains its three original illustrated picture rewards. Its [browser/offline report](verification/round-19/frozen-browser.md), [source gates](verification/round-19/source-gates.md) and [integrity record](verification/round-19/integrity-notes.md) identify the frozen artifact. The browser report records an out-of-order mission replayability issue for the next iteration. Ongoing source changes are not themselves release evidence. Automated results do not certify every target below.
