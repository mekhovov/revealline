...
The preserved v0.10.0 source supplies 28 maps, seven gameplay roles, four presentation themes, five installable expansions and six effective optional equipment goals. Short chapters now award their last appearance tier at the actual chapter size, and completed maps remain replayable after out-of-order restores. Equipment Workshop contains three themed examples of [pack-authored goals](pack-mastery-contract.md); Homeward Skies retains its three original illustrated picture rewards. Its [browser/offline report](verification/round-20/frozen-browser.md), [1,128-test source gates](verification/round-20/source-gates.md) and [integrity record](verification/round-20/integrity-notes.md) identify the frozen artifact. Ongoing source changes are not themselves release evidence. Automated results do not certify every target below.
