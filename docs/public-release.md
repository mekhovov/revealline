...
The latest public version is **v0.19.0**, source `9b97ea4ab0fa43c583c060d79f6806a6ec599b43`, available at [Reveal / Line](https://mekhovov.github.io/revealline/). [Workflow 34711246234](https://github.com/mekhovov/revealline/actions/runs/34711246234) passed. The deployment task verified public build metadata, pack installation and launch, saved-flight exports, missing-pack rescue, exact paused restoration and empty browser logs; see [its attributed acceptance record](verification/round-28/v019-public-deployment.md).

The separate frozen **v0.19.0** archive uses that same source commit. All [six source gates](verification/round-28/v019-source-gates.md) pass **1,667 tests** on **352 unchanged committed inputs**. [Independent integrity verification](verification/round-28/v019-integrity.md) reproduces all **146 packaged files** and confirms exact equality with the browser-tested candidate. Its [offline journey](verification/round-28/v019-browser.md) prepared **139 files / 31,820,110 bytes**, then installed bundled packs, exported and restored unfinished flights, completed Copper Orchard and retained its picture, score and seal with the server stopped. Grid recovery exports preserved their exact replay. These observations do not establish physical-device or native-store behavior.

v0.19 adds cancellable current/saved attempt export. v0.18 introduced Pack/Level selectors, campaign launch links and the [gallery-clock repair](verification/round-28/gallery-clock.md); its original source `3eb42d7cb118d443e474682ee382484e0bf3c7f4`, [deployment workflow](https://github.com/mekhovov/revealline/actions/runs/34708917074) and [144-file archive audit](verification/round-28/v018-preservation.md) remain preserved. Earlier results below describe their own versions.
...
| Public website                | v0.19 deployed on GitHub Pages; metadata, pack/export/rescue journeys and page logs verified      | Verify later deployments and host-specific MIME/CSP/cache, privacy and rollback behavior not covered by that evidence |
