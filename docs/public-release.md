...
The latest preserved release is [v0.14.0](http://127.0.0.1:8767/releases/v0.14.0/site/game/), tagged at `21dfaeed08df95e7cb1d0e20c28c39b3fd3364ee`. It adds [finite loss reasons and retry guidance](retry-feedback.md), including a compact-screen reset note inside the existing reader. Reading or exiting never retries automatically; explicit Retry resets the current attempt while retaining existing collection rewards. No simulation or portable-data format changed.
