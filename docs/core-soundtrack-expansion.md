...
| New archive previews     | 170 public archive recordings across 31 collections on two public archives; the immutable 104-recording baseline and its later additions retain separate publication evidence                                                                     | Full listening, taste approval and game admission remain; zero new game admissions                                           |
...
Authoritative game `main` is now `9289184d8c36c85261493b8a31ba36e8ffb931ee`: the narrow v0.132.4 Team repair merged as `d878a879848cea271f1098774ef897dfbf6d806f`, the soundtrack ledger correction merged through PR #640, and terminal release-root PR #641 merged without changing soundtrack runtime behavior. Archive-directory client PR #604 was rebased cleanly onto that cumulative source at `6d3d6731a4c81b18da16ae8876fdf4b2e4208476`. Its catalogue, panel and player cohort passes 177/177 locally. The prior hosted run passed 9/9 archive-directory tests and 20/21 host tests; its sole failure was the recovery-complete MP3 bundle assembly exceeding the test's two-second polling budget. The rebased successor retains every binary, focus, no-auto-download and gameplay-state assertion while giving that exact byte-bound operation a finite fifteen-second budget; exact-head run 36230776668 is active. Opening-theme fallback PR #617 is rebased onto the same cumulative source at `e9acd1b9df3d11b05d557639c40240cb5873c78a`; its focused regression passes 7/7 locally and exact-head run 36230785270 is active. Both remain draft and unallocated. The fast-release policy skips their full test/build jobs, so those skips remain exclusions rather than passes.
...
2. **M8 stream recovery:** desktop delivery is complete in v0.130.0. Merged test-only
   ...
   `e9acd1b9df3d11b05d557639c40240cb5873c78a`. Its 7/7 focused Node 20.20.0 regression verifies that a
...
8. **Archive scale-out:** archive
   ...
   `9289184d8c36c85261493b8a31ba36e8ffb931ee` at exact head
   `6d3d6731a4c81b18da16ae8876fdf4b2e4208476`. The 177/177 catalogue, panel and
   player cohort plus formatting pass locally. Prior hosted run 36230220903 passed
   the nine archive-directory tests and 20/21 host tests; its sole failure was the
   recovery-complete MP3 bundle assembly exceeding a two-second polling budget.
   The successor raises only that finite test budget to fifteen seconds and keeps
   all output and ownership assertions. Exact-head run 36230776668 is active. Full
   tests and build remain skipped under the unallocated fast-release policy.
   Archive 02 publishes seven recordings independently, but do not add it to the
...
Authoritative `main` is `9289184d8c36c85261493b8a31ba36e8ffb931ee`;
...
- Archive directory [PR #34](https://github.com/mekhovov/revealline-soundtracks-01/pull/34)
  ...
  is rebased on authoritative main `9289184d8c36c85261493b8a31ba36e8ffb931ee` at exact head `6d3d6731a4c81b18da16ae8876fdf4b2e4208476`; its focused catalogue, panel and player cohort passes 177/177 locally. Exact-head hosted run 36230220903 passed the nine archive-directory tests and 20/21 host tests; the sole failure was the finite binary-preparation wait. Preserve that evidence. The successor retains all output and ownership assertions with a fifteen-second byte-bound budget; run 36230776668 is the authoritative exact-head gate. Full test/build jobs remain skipped. The next action
