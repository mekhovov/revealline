...
| New archive previews     | 169 public archive recordings across 30 collections on two public archives; the immutable 104-recording baseline and its later additions retain separate publication evidence                                                                     | Full listening, taste approval and game admission remain; zero new game admissions                                           |
...
the primary Pages selector serves it. Authoritative game `main` advanced to
`5ad50f23607b0af57b8f77170bf2b72f41f375d6` after v0.132.3 publication, the
fastline release-object guard and the latest soundtrack plan checkpoints landed. The soundtrack branches were rebased onto
that exact accepted main after publication. Archive-directory client PR #604 was rebased cleanly
onto that exact main at `d91256d18800563658f4df12a2d92a6a0992043b`. Its combined catalogue, panel and
...
`fcc0ebad40b5a2f7d6ebe3b2c78dd7bf573c37df` and passes its hosted focused gate plus
...
Local free space is about **2.2 GiB**, above the required 1 GiB floor but still too
...
2. **M8 stream recovery:** desktop delivery is complete in v0.130.0. Merged test-only
   ...
   `fcc0ebad40b5a2f7d6ebe3b2c78dd7bf573c37df`. Its 7/7 focused Node 20.20.0 regression verifies that a
...
8. **Archive scale-out:** archive
   ...
   `5ad50f23607b0af57b8f77170bf2b72f41f375d6` at exact head
   `d91256d18800563658f4df12a2d92a6a0992043b`. The 177/177 catalogue, panel and
   ...
   tests remain skipped under the unallocated release hold. Archive 02 now publishes six recordings independently, but do not add it to the public directory until that client is released. Archive PR #41 raises Archive 01 to 887,503,800 audio bytes; its exact
...
Authoritative `main` is `5ad50f23607b0af57b8f77170bf2b72f41f375d6`;
v0.132.3 is public and does not contain a new soundtrack feature. The sole
publisher subsequently found a source-binding mismatch between its public tag/release
and the intended admitted release-root source; preserve v0.132.3 immutably and use a
new version for recovery.
v0.132.0 and its
...
- Release publication is temporarily serialized behind the sole publisher's immutable
  recovery. Guard [PR #632](https://github.com/mekhovov/revealline/pull/632) is
  merged and refuses mismatched release objects. Do not retag or overwrite public
  v0.132.3; resume soundtrack allocation only after the publisher selects and
  qualifies a new recovery version.
...
- Local free space is **about 2.2 GiB** at this checkpoint. Preserve reachable
...
- Archive directory [PR #34](https://github.com/mekhovov/revealline-soundtracks-01/pull/34)
  ...
  is rebased on authoritative main `5ad50f23607b0af57b8f77170bf2b72f41f375d6`
  at exact head `d91256d18800563658f4df12a2d92a6a0992043b`; its focused catalogue,
  ...
  activating Archive 02 in the reviewed directory.
...
`5ad50f23607b0af57b8f77170bf2b72f41f375d6`. It records archive publication and
