...
a direct follow-up measurement reported **5.9 GiB available**. Small, bounded audio
intakes may resume. Recheck the reserve before every acquisition or build and stop
again below the 1 GiB floor.
...
6. **Archive scale-out:** Archive 01 carries 887,503,800 audio bytes. Archive 02 is
   now public with ten recordings, 50,780,112 audio bytes and a verified player. Release
...
`d3df9d47f578d48383ff589914a188ada2ef8b31`. It records archive publication and
