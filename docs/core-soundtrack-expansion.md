...
Shared local free space fell to approximately **0.50 GiB** after the Last Stand publication while another release workflow was active. This is below the 1 GiB guard. All further media intake and local builds are stopped until coordinated cleanup restores the reserve; preserve user changes, frozen releases and evidence.
