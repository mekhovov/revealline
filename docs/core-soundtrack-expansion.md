...
Authoritative game `main` is now `fad132a054a10f27198751bfeb7c02ba340cfbfb`: inspector correction PR #644 followed terminal release-root `9289184d8c36c85261493b8a31ba36e8ffb931ee`; the narrow v0.132.4 Team repair merged as `d878a879848cea271f1098774ef897dfbf6d806f`, the soundtrack ledger correction merged through PR #640, and terminal release-root PR #641 merged without changing soundtrack runtime behavior. Archive-directory client PR #604 was rebased cleanly onto that cumulative source and now has exact head `9501f3d48a49611b6ea9942414d75ef70ca78192`. Its catalogue, panel and player cohort passes 177/177 locally. Preserve failed hosted runs 36230776668 and 36231230104: both passed 9/9 archive-directory tests and 20/21 host tests, but the latter established that controller Confirm had not rearmed after expanding Backup tools, so the real Prepare handler was never invoked. The current test-only fix advances the deterministic fake clock through the existing 120 ms Confirm lifecycle before invoking Prepare; exact-head run 36231736506 is authoritative and active. Opening-theme fallback PR #617 is rebased onto the same cumulative source at `2c10aaa5711baf92f0cb0690f0bfd56d453c1810`; its focused regression passes 7/7 locally and prior exact-head run 36230785270 passed preflight, focused and release-ready; rebased successor run 36231743707 is authoritative and active. Both remain draft and unallocated. The fast-release policy skips their full test/build jobs, so those skips remain exclusions rather than passes.
...
8. **Archive scale-out:** archive
   ...
   player cohort plus formatting pass locally. Preserve exact hosted failures
   36230776668 and 36231230104: the latter proves the second controller Confirm
   was still within the production 120 ms rearm window and never invoked Prepare.
   The current test-only successor advances that deterministic lifecycle before
   asserting and awaiting the real handler; run 36231736506 is authoritative. Full
...
- Archive directory [PR #34](https://github.com/mekhovov/revealline-soundtracks-01/pull/34)
  ...
  is rebased on authoritative main `fad132a054a10f27198751bfeb7c02ba340cfbfb` at exact head `9501f3d48a49611b6ea9942414d75ef70ca78192`; its focused catalogue, panel and player cohort passes 177/177 locally. Exact-head hosted run 36230220903 passed the nine archive-directory tests and 20/21 host tests; the sole failure was the finite binary-preparation wait. Preserve that evidence. The successor retains all output and ownership assertions with a fifteen-second byte-bound budget; runs 36230776668 and 36231230104 are retained failures; run 36231736506 is the authoritative exact-head gate. Full test/build jobs remain skipped. The next action
