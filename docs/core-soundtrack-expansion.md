...
| New archive previews     | 173 public archive recordings across 34 collections on two public archives; the immutable 104-recording baseline and its later additions retain separate publication evidence                                                                     | Full listening, taste approval and game admission remain; zero new game admissions                                           |
...
Local free space recovered to about **1.29 GiB** after removing only regenerable
temporary staging data. The 1 GiB guard permits only one small bounded intake at
a time. Stop before any write that would cross the floor; preserve user changes,
