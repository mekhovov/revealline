...
**Current implementation checkpoint — 26 September 2026:** immutable v0.141.6 is
public and accepted. Authoritative `main` is
`b08aca5e192aef0482455c02b81ee86dd5bac909`. The live archives expose **183 exact
recordings / 44 collections**: Archive 01 has 163 recordings / 24 collections /
887,503,800 audio bytes, and Archive 02 has 20 recordings / 20 collections /
111,830,953 audio bytes. This checkpoint supersedes older counts and branch heads
retained later in this document as history.
...
private intake is active in draft [PR #706](https://github.com/mekhovov/revealline/pull/706):
...
rights remain personal and cannot enter the public/share path. Focused source status
is 107/107 tests, deterministic localization, ESLint, Prettier and diff checks green.
Exact-head hosted gates, independent review, merge, version allocation, immutable
release and public browser acceptance remain. Estimated hands-on work after green
review is 0.5–1 day, excluding CI and the release queue.
...
2. **M8 stream recovery:** desktop delivery is complete in v0.130.0. Merged test-only
   ...
   `54cf82676c812a8a95e8d0d1dbb57692923520b6`. Its 7/7 focused Node 20.20.0 regression verifies that a
...
8. **Archive scale-out:** archive
   ...
   `57f6c50921f3912359769c61e43dbf4525ccaafa` at exact head
   `06ff06366f1ed83f2073ca0523e990f61cffc6e2`. The 177/177 catalogue, panel and
   player cohort plus formatting pass locally; the wider host suite retains a
   current-main timing flake. Hosted preflight and reconciliation passed, while the
   latest hosted focused gate failed and is under exact-log diagnosis. Full tests
   and build remain skipped under the unallocated fast-release policy. Archive 02
