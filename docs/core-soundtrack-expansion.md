...
| New archive previews     | 183 public archive recording files across 44 collections on two public archives, representing 182 distinct compositions because the second Synthwave Type encoding is a documented duplicate; Archive 02 PRs #15–#19 publish the latest rights-cleared industrial/EDM-metal auditions | Full listening, taste approval and game admission remain; zero new game admissions                                           |
...
Current GitHub `main` subsequently advanced through [PR #564](https://github.com/mekhovov/revealline/pull/564) to `5d6c97c850a648c5ebe93d3cf57731aeb67d0bbb`, whose merge title allocates v0.141.0 while the latest immutable public release remains v0.132.5. Release coordination now treats the older v0.133 allocation as obsolete and is resequencing the pending player slices onto v0.141.1–v0.141.8. This source/public gap is a release-coordination concern, not authority to retag or publish. Per the explicit latest-main request, archive-directory client [PR #604](https://github.com/mekhovov/revealline/pull/604), opening-theme fallback [PR #617](https://github.com/mekhovov/revealline/pull/617) and this plan [PR #643](https://github.com/mekhovov/revealline/pull/643) are rebased onto exact current `main`. Their refreshed source heads before this documentation follow-up are respectively `84f426eb54ba9337b1436a9dc4a97177cbe473cd`, `b8f524fb5d30ecc1393fc05b3fe71c2d504ce903` and the documentation successor created by this update. PR #604 passes 198/198 focused catalogue, host, panel and player tests after the rebase; exact-head [run 36245826255](https://github.com/mekhovov/revealline/actions/runs/36245826255) passed preflight, focused and release-ready. PR #617 passes 7/7 focused tests and formatting; exact-head [run 36245831752](https://github.com/mekhovov/revealline/actions/runs/36245831752) passed preflight, focused and release-ready. Preserve failed hosted runs 36230776668, 36231230104, 36231736506, 36232156154 and 36232552706. Full test/build jobs were skipped under the temporary fast-release policy, so they remain exclusions. Both feature PRs are clean but remain draft until the sole release owner assigns a post-v0.141 integration boundary. Soundtrack merge/version/tag/publication remains sole-release-owner coordinated.
...
Archive 02 [PR #8](https://github.com/mekhovov/revealline-soundtracks-02/pull/8)
merged as `f93e8bca81d9b84c6425fddd3f775679bec46d65` and publishes
**Bouncer** by Of Far Different Nature under CC0. The exact creator MP3 is
3,755,320 bytes with SHA-256
`453f703d5b3fdb6045078c446ff82bad97b19eb6b660ed2da76b64dd971bfcba`;
the normalized 320 kbps derivative is 3,753,476 bytes with SHA-256
`c6a1df8144d57402088198bdb2032dc682fde90e6946796931ee3e07053cc64e`,
measured at -16.0 LUFS integrated and -8.6 dBTP. Exact-head verification and
Pages [run 36233659496](https://github.com/mekhovov/revealline-soundtracks-02/actions/runs/36233659496)
passed. Direct public reads verified nine catalogue rows, the complete published
hash, CORS and HTTP 206. Browser playback started Bouncer and switched to
runner2088 in place. The recording remains listening-pending, Recording-mode
ineligible and outside game defaults. Archive 02 now holds nine recordings / nine
collections / 48,047,386 audio bytes; aggregate public archives hold
**172 recordings / 33 collections**.

Archive 02 [PR #9](https://github.com/mekhovov/revealline-soundtracks-02/pull/9)
merged as `8bc5f7979847c3344a5f3efd1caff884aef2f2f3` and publishes
**StarShooter v2.1** by Centurion_of_war under CC0. The creator's three OGG
uploads are treated as revisions of one composition; only the newest v2.1 file is
published. Its exact 4,853,743-byte source has SHA-256
`457b662361847137c28a92b6acd60f03d77f0e522a5c73b02c9f04cf792a2e9a`;
the normalized 2,732,726-byte, 256 kbps MP3 has SHA-256
`c6b7641b556e7f245681bee6a162703725c58bf591ba4ba548492f35a0d4486e`,
-16.89 LUFS integrated and -1.12 dBTP. Exact-head verification and Pages
[run 36234017631](https://github.com/mekhovov/revealline-soundtracks-02/actions/runs/36234017631)
passed. Direct public reads verified ten catalogue rows, complete published bytes,
the exact hash, CORS and HTTP 206. Browser playback started StarShooter and
switched to Hot Roadway in place. It remains listening-pending,
Recording-mode-ineligible and outside game defaults. Archive 02 now holds ten
recordings / ten collections / 50,780,112 audio bytes; aggregate public archives
hold **173 recordings / 34 collections**.

Archive 02 [PR #10](https://github.com/mekhovov/revealline-soundtracks-02/pull/10)
merged as `f76cf207cfb1dc825d6d2aa201b360f3454fe921` and publishes the 1:33
**Last Stand Lets Go** by Noah Cedeno (Peachtea) as a synth-metal audition under
CC0. The exact 2,110,508-byte creator MP3 has SHA-256
`94a15e5c78640ca23410acfdbf65b9ab4a6a26d93534ec973b4aa6ed1bddf6af`;
the 2,962,988-byte 256 kbps derivative has SHA-256
`ee3bed8e7c91ab050ccd32bd469646153ffb6ead81d2d19f945c8384eb9cb99e`,
-16.0 LUFS integrated and -1.7 dBTP. Exact verification and Pages
[run 36235083805](https://github.com/mekhovov/revealline-soundtracks-02/actions/runs/36235083805)
passed. Direct public reads verified the complete hash, CORS and HTTP 206; browser
playback advanced past 15 seconds and switched to runner2088 in the same player.
It remains listening-pending, Recording-mode-ineligible, game-unadmitted and
outside defaults. Archive 02 now holds eleven recordings / eleven collections /
53,743,100 audio bytes; aggregate public archives hold **174 recordings / 35
collections**.

Draft Archive 01 [PR #42](https://github.com/mekhovov/revealline-soundtracks-01/pull/42)
prepares the next delivery step by adding Archive 02 to the bounded discovery
directory as optional while Archive 01 remains first and required. Exact-head
hosted [run 36235670778](https://github.com/mekhovov/revealline-soundtracks-01/actions/runs/36235670778)
...
SHA. PR #652 subsequently merged, and throughput PR #653 merged before independent
review found two release-contract corrections. Correction
[PR #656](https://github.com/mekhovov/revealline/pull/656) is now merged; current
`main` is `bc5378cf186681aa311fccbf180d295cc3bc0a6c`. Terminal release
[PR #654](https://github.com/mekhovov/revealline/pull/654) was updated after the
correction and merged as `72cfc74552669699266d5d8ad92c56a69da885b2`.
Replacement exact-head run 36238193318 passed preflight, focused, build and
...
[PR #11](https://github.com/mekhovov/revealline-soundtracks-02/pull/11)
merged as `24d3329d04e68334de867c8c120375839f23798f` and publishes
**Chase** by Adiutorium as a full-length neon electro/EDM audition under CC0.
Exact verification and Pages
[run 36237279763](https://github.com/mekhovov/revealline-soundtracks-02/actions/runs/36237279763)
passed. The native 10,477,472-byte MP3 has SHA-256
`f033d26bb2bb2e6b3fb7db60e491b4dbea0c32f3ac92e8c9b18718759410a601`;
the 8,383,571-byte public derivative has SHA-256
`979f4c72390bfe142f588e0cb8e87b34b5edb8db7c2824443b8767ad8121a598`,
decodes to 261.936 seconds and measures -16.0 LUFS / -1.1 dBTP. Direct public
reads verified exact bytes, CORS and HTTP 206. Browser playback advanced past
eleven seconds and Next switched to Sky Trance in the same player. Chase remains
listening-pending, game-unadmitted, outside defaults and Recording-mode-ineligible.
...
multi-archive game client is public. Duplicate review closed the earlier
source-only slate: Archive 01 already publishes
[The Wreck](https://mekhovov.github.io/revealline-soundtracks-01/?track=zander-noriega.the-wreck#recordings),
so it is not another candidate; Techno DRIVE proceeded only after both public
catalogues showed no matching source, title or recording.

Archive 02
[PR #12](https://github.com/mekhovov/revealline-soundtracks-02/pull/12)
merged as `2ba6e0a0ab6c53ed4128d57ba6a07c8edb28e772` and publishes a
normalized **Synthwave Type** derivative by G_P under CC0. Exact verification and
Pages [run 36237829439](https://github.com/mekhovov/revealline-soundtracks-02/actions/runs/36237829439)
passed. Direct public checks verified the 3,622,954-byte object, SHA-256
`5e9521d353af87cb357e5077eec619fe3db10dc8a55ebf2978593285abc639ad`,
CORS and HTTP 206. Browser playback advanced beyond ten seconds and Next switched
to runner2088 without leaving the player. Source evidence then confirmed that
Archive 01 already publishes the same composition and native source as
`g-p.synth-type`. This second encoding therefore does **not** increase the distinct
composition count and must be excluded or canonically deduplicated before Archive
02 is activated in the game. Preserve its immutable public bytes and record this
as a publication-process regression. Archive 02 has 13 published recordings / 13
collections; the two archives expose 176 recording files / 37 collections but
only **175 distinct compositions** at that checkpoint.

Archive 02
[PR #13](https://github.com/mekhovov/revealline-soundtracks-02/pull/13)
merged as `f765b78270f78693e88aae782c983c09ee393615` and publishes
**Techno DRIVE!!! (V2)** by Centurion_of_war under CC BY 4.0. The faster V2
arrangement is the single public representative of the composition; its original,
slow, chiptune and heavy-metal variants do not increase the composition count.
Exact verification and Pages
[run 36238196852](https://github.com/mekhovov/revealline-soundtracks-02/actions/runs/36238196852)
passed. The exact 1,713,371-byte native OGG and its normalized 2,254,574-byte MP3
hashes are retained. Direct public reads verified the MP3 SHA-256
`2188a84b5628dbdf419126dbc243fbae0739b1d0327b1e22831852a954dc2290`,
CORS and HTTP 206. Browser playback advanced beyond eight seconds; Next selected
Blue Beat in the same player, although that follow-on stream had not reached a
ready state before the observation ended. Techno DRIVE remains listening-pending,
short-loop-only, game-unadmitted, outside defaults and Recording-mode-ineligible.
The public archives exposed **177 recording files / 38 collections / 176
distinct compositions** at that checkpoint.

Archive 02
[PR #14](https://github.com/mekhovov/revealline-soundtracks-02/pull/14)
merged as `29fc2e98dd83269caa7ed8ff4879b8f5f1709eb4` and publishes the
five-minute **Metallic Mistress** by FoxSynergy under CC BY 3.0. Exact verification
and Pages
[run 36238496098](https://github.com/mekhovov/revealline-soundtracks-02/actions/runs/36238496098)
passed. The 4,521,288-byte native MP3 and normalized 9,588,077-byte derivative
hashes are retained. The first derivative reached -0.90 dBTP and was rejected
before commit; the public file measures -16.06 LUFS and -1.20 dBTP. Direct reads
verified SHA-256 `4d807399b7ceb8d45c79c44337769d305db6fda690072ecdb5eed7e99e06c1c0`,
CORS and HTTP 206. Browser playback advanced beyond ten seconds; Next selected
Last Stand in the same player, but the follow-on stream had not reached a ready
state before the observation ended. Metallic Mistress remains listening-pending,
...
Shared local free space fluctuated during concurrent release work and fell to
...
4. **M1/M2 soundtrack admission and opening theme:** aggregate #518 and theme #519
   ...
   parallel.
5. **M6 full-length metal review:** review nine already-public, exact-source
...
6. **M5/M6 new public auditions:** archive PR #33 publishes five metal-energy and
   ...
   Archive 02
   [PR #15](https://github.com/mekhovov/revealline-soundtracks-02/pull/15)
   adds **Sandblaster** by Clearside as a CC BY-SA 3.0 industrial-metal audition and
   merged as `da57491207249f46ee1d84a7a7f9632be6bb171e`. Its 256 kbps derivative
   measures -16.0 LUFS / -3.0 dBTP and preserves the exact creator-source hash,
   attribution, ShareAlike delivery terms and change notice. Exact-head verification
   and Pages [run 36239593538](https://github.com/mekhovov/revealline-soundtracks-02/actions/runs/36239593538)
   passed. Direct public reads verified the 3,821,861-byte SHA-256 object, CORS and
   HTTP 206. Browser playback advanced beyond ten seconds and Next changed to another
   archive recording that also reached ready state and advanced. Sandblaster remains
   listening-pending, game-unadmitted and Recording-mode-ineligible.
   Archive 02 [PR #16](https://github.com/mekhovov/revealline-soundtracks-02/pull/16)
   then published David KBD’s full 4:08 **Space Odyssey** under CC BY 4.0. It
   merged as `1f26595562abb21f1f6e3d8e3727d616a63c8259`; exact verification and
   Pages [run 36240086855](https://github.com/mekhovov/revealline-soundtracks-02/actions/runs/36240086855)
   passed. Direct reads verified SHA-256, CORS and HTTP 206; same-page playback
   ...
   Archive 02 [PR #17](https://github.com/mekhovov/revealline-soundtracks-02/pull/17)
   then published David KBD’s complete 3:38 **Red Dwarf** under CC BY 4.0. It
   merged as `35c9fcb9c4253418a3b7105ab6495a57bd56f196`; exact verification and
   Pages [run 36240309219](https://github.com/mekhovov/revealline-soundtracks-02/actions/runs/36240309219)
   passed. Direct reads verified SHA-256, CORS and HTTP 206; same-page playback
   reached ready state and advanced. The exact creator OGG hash and derivative
   disclosure are retained. It remains listening-pending, game-unadmitted and
   Recording-mode-ineligible.
   ...
   Archive 02 [PR #19](https://github.com/mekhovov/revealline-soundtracks-02/pull/19)
   then published David KBD's complete 4:22 **Deep Space** under CC BY 4.0. It
   merged as `fdfbe8022a62589fb4e47d747016fabfc5daf775`; exact verification and
   Pages [run 36246025418](https://github.com/mekhovov/revealline-soundtracks-02/actions/runs/36246025418)
   passed. The exact 4,648,773-byte creator OGG has SHA-256
   `eb1ef3dbe7b7edfa1b4487d7a95892d7b31ebe0bdaa56e569244a1f1ead2c4c5`;
   the 8,395,052-byte public 256 kbps MP3 has SHA-256
   `d2e43220233114d41ad940791fc3d5a014f7c48074b63578d5e00cedc360e28b`
   and measures -16.0 LUFS / -6.3 dBTP. Direct public reads verified exact bytes,
   CORS and HTTP 206. Browser playback reached ready state and advanced without a
   media error. It remains listening-pending, game-unadmitted and
   Recording-mode-ineligible. The two public archives now expose **183 recording
   files / 44 collections / 182 distinct compositions**.
...
8. **Archive scale-out:** archive
   ...
   Archive 02 publishes ten recordings independently, but do not add it to the
...
The latest accepted public/general GitHub release at this checkpoint remains [v0.132.3](https://github.com/mekhovov/revealline/releases/tag/v0.132.3). Terminal v0.132.4 release-root PR #641 merged at `9289184d8c36c85261493b8a31ba36e8ffb931ee`; qualification and freeze passed in run 36230679721, but independent inspection failed with `Original manual source/freeze run identity differs`, so publication correctly stopped. Preserve that failure. Inspector correction PR #644 enabled fresh qualification, freeze and independent inspection, but evidence assembly then rejected the valid combination of a skipped nested inspection and successful top-level inspection. Evidence-authority repair PR #645 advanced authoritative main to `80911bf5ec0f6df711d7e70b36a11005d2be4c3a`; the sole publisher is requalifying that exact source before any immutable v0.132.4 tag, release or selector write. Publication and direct public Team acceptance remain publisher-owned. The latest
...
- Release publication is temporarily serialized behind v0.132.4. Its narrow Team
  ...
  merged as `d878a879848cea271f1098774ef897dfbf6d806f`; PR #640 changed documentation only and terminal release-root PR #641 merged as `9289184d8c36c85261493b8a31ba36e8ffb931ee`. Preserve the original inspection failure, the later evidence-assembly failure, and their scoped repairs in PRs #644/#645. Immutable publication, selector deployment and direct public Team verification remain with the sole publisher. Guard
...
- Local free space is **about 1.29 GiB** at this checkpoint. Preserve reachable
...
- The stronger M6 shortlist now includes David KBD's free, CC BY 4.0,
  ...
  admission.
- **Last Stand Lets Go** is now published as a listening-unapproved Archive 02
  audition through PR #10. Remaining research leads are retained rather than added
  blindly: [Megasong](https://opengameart.org/content/megasong)
  ...
  (CC BY 4.0 driving loop). The remaining leads require exact-file acquisition and complete
...
| M5  | Later-direction synth/action auditions, runner2088, Bouncer, StarShooter, the Last Stand synth-metal crossover, Chase and Techno DRIVE V2 are public; the second Synthwave Type encoding is documented as a duplicate and does not count as another composition; Electric Dreams remains the closest accepted synth reference | Musical fit, full listening and exact admission review; multi-archive client release before Archive 02 directory activation       | Review runner2088, Pure Raceway, Pure Raceway (Climax), Darkness Road (Remake), Sky Trance, Cyber Power Mix, Blue Beat, Hit the Womp, Ripped Apart, Hot Roadway, Lost in the Snow Wave, Bouncer, StarShooter, Last Stand Lets Go, Chase and Techno DRIVE V2; exclude or canonically deduplicate Archive 02 Synthwave Type before directory activation; compare HexaPuppies after disk recovery; admit only a musically accepted subset | Several hours per comparison round; 1–2 days integration/verification after approval; CI/review waits excluded | Archive [PR #25](https://github.com/mekhovov/revealline-soundtracks-01/pull/25), Pages run 36147468099; closed/superseded Archive 01 [PR #23](https://github.com/mekhovov/revealline-soundtracks-01/pull/23); Archive 02 [PR #1](https://github.com/mekhovov/revealline-soundtracks-02/pull/1), Pages run 36226671256; Archive 02 audition [PR #3](https://github.com/mekhovov/revealline-soundtracks-02/pull/3), Pages run 36227956411; Archive 02 electro [PR #4](https://github.com/mekhovov/revealline-soundtracks-02/pull/4), Pages run 36228503805; Archive 02 rhythm [PR #5](https://github.com/mekhovov/revealline-soundtracks-02/pull/5), Pages run 36229239473; Archive 02 racing [PR #6](https://github.com/mekhovov/revealline-soundtracks-02/pull/6), Pages run 36230403309; Archive 02 synthwave [PR #7](https://github.com/mekhovov/revealline-soundtracks-02/pull/7), Pages run 36231418029; Archive 02 electro racing [PR #8](https://github.com/mekhovov/revealline-soundtracks-02/pull/8), Pages run 36233659496; Archive 02 retro racing [PR #9](https://github.com/mekhovov/revealline-soundtracks-02/pull/9), Pages run 36234017631; Archive 02 synth-metal [PR #10](https://github.com/mekhovov/revealline-soundtracks-02/pull/10), Pages run 36235083805; industrial metal [PR #14](https://github.com/mekhovov/revealline-soundtracks-02/pull/14), Pages run 36238496098; Archive 02 neon electro [PR #11](https://github.com/mekhovov/revealline-soundtracks-02/pull/11), Pages run 36237279763; duplicate-encoding evidence [PR #12](https://github.com/mekhovov/revealline-soundtracks-02/pull/12), Pages run 36237829439; Techno DRIVE [PR #13](https://github.com/mekhovov/revealline-soundtracks-02/pull/13), Pages run 36238196852; optional directory draft [PR #42](https://github.com/mekhovov/revealline-soundtracks-01/pull/42), exact-head verifier run 36235670778; intake [PR #28](https://github.com/mekhovov/revealline-soundtracks-01/pull/28); publication [PR #33](https://github.com/mekhovov/revealline-soundtracks-01/pull/33); auditions [PR #37](https://github.com/mekhovov/revealline-soundtracks-01/pull/37) and [PR #41](https://github.com/mekhovov/revealline-soundtracks-01/pull/41) | Public audition in Archive 02; unreleased in game                                      |
| M6  | Purgatory PR #26, Reckless PR #27, five further energy auditions in PR #33, Heavy Dungeon in PR #37, Last Stand in Archive 02 PR #10, Metallic Mistress in Archive 02 PR #14, Sandblaster in Archive 02 PR #15, Space Odyssey in Archive 02 PR #16 and Red Dwarf in Archive 02 PR #17 are public                              | Full listening, transitions, warnings, Content ID and gameplay acceptance                                                         | Review the seven Interstellar/Purgatory tracks, then four Reckless tracks, then Calamity, Nox Venator, Rabidus, Fight for Better Future, The Destoroya, Heavy Dungeon, Last Stand Lets Go, Metallic Mistress, Sandblaster, Space Odyssey and Red Dwarf; admit only an accepted subset                                                                                                                                                  | Several hours per listening round; 1–2 days integration after approval; CI waits excluded                      | Purgatory [PR #26](https://github.com/mekhovov/revealline-soundtracks-01/pull/26); Reckless [PR #27](https://github.com/mekhovov/revealline-soundtracks-01/pull/27); direct queue [PR #593](https://github.com/mekhovov/revealline/pull/593); intake [PR #28](https://github.com/mekhovov/revealline-soundtracks-01/pull/28); publication [PR #33](https://github.com/mekhovov/revealline-soundtracks-01/pull/33); next audition [PR #37](https://github.com/mekhovov/revealline-soundtracks-01/pull/37); synth-metal [PR #10](https://github.com/mekhovov/revealline-soundtracks-02/pull/10), Pages run 36235083805; industrial metal [PR #14](https://github.com/mekhovov/revealline-soundtracks-02/pull/14), Pages run 36238496098; Sandblaster [PR #15](https://github.com/mekhovov/revealline-soundtracks-02/pull/15), Pages run 36239593538; Space Odyssey [PR #16](https://github.com/mekhovov/revealline-soundtracks-02/pull/16), Pages run 36240086855; Red Dwarf [PR #17](https://github.com/mekhovov/revealline-soundtracks-02/pull/17), Pages run 36240309219                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | Twenty-two prioritized metal/fusion candidates public; none newly admitted             |
...
| M8  | Public desktop mixed-source recovery is complete; fresh v0.132 exposed an opening-theme acquisition timeout; replacement PR #617 contains the bounded built-in fallback                                                                                                                                                       | Release-slot allocation after the active PR #590/v0.133 lane, fresh exact-head gates, physical devices and cold-offline execution | Release PR #617, directly verify first-run failure recovery and source switching, then finish cold restart and iPhone/controller checks                                                                                                                                                                                                                                                                                                | 0.5–1 working day after release allocation, plus device access                                                 | PR #370/v0.111.0; repair [PR #523](https://github.com/mekhovov/revealline/pull/523); regression [PR #555](https://github.com/mekhovov/revealline/pull/555); offline runtime [PR #536](https://github.com/mekhovov/revealline/pull/536); replacement fallback [PR #617](https://github.com/mekhovov/revealline/pull/617) at rebased head `aa9add7af6dd509f27949b31124b2076e4fce4a1`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | v0.130.0 desktop accepted; v0.132.5 public and accepted; first-run fallback unreleased |
...
6. **Archive scale-out:** Archive 01 carries 887,503,800 audio bytes. Archive 02 is
   now public with 18 recording files across 18 collections and a verified player. Release
...
This plan checkpoint is reconciled through authoritative accepted game main
`8f7ea5540d6851fb2d6d77a42c899e071e65e52a`. It records archive publication and
...
1. [Deep Space — 4:22](https://mekhovov.github.io/revealline-soundtracks-02/?track=david-kbd.deep-space#recordings)
2. [Stellar Confrontation — 3:42](https://mekhovov.github.io/revealline-soundtracks-02/?track=david-kbd.stellar-confrontation#recordings)
3. [Solar Storm — 3:46](https://mekhovov.github.io/revealline-soundtracks-01/?track=davidkbd.solar-storm#recordings)
4. [Galactic Battle — 3:46](https://mekhovov.github.io/revealline-soundtracks-01/?track=davidkbd.galactic-battle#recordings)
5. [Orbital Assault — 3:06](https://mekhovov.github.io/revealline-soundtracks-01/?track=davidkbd.orbital-assault#recordings)
6. [Mutilation's Melody — 2:13](https://mekhovov.github.io/revealline-soundtracks-01/?track=davidkbd.mutilations-melody#recordings)
7. [Bone Grinder's Ballad — 2:05](https://mekhovov.github.io/revealline-soundtracks-01/?track=davidkbd.bone-grinders-ballad#recordings)
8. [The Slicing Strain — 2:12](https://mekhovov.github.io/revealline-soundtracks-01/?track=davidkbd.the-slicing-strain#recordings)
9. [Visceral Vengeance — 1:55](https://mekhovov.github.io/revealline-soundtracks-01/?track=davidkbd.visceral-vengeance#recordings)
...
Duplicate screening against both public archive catalogues found several additional
creator-published CC BY 4.0 recordings that are not yet present. Use these as a
bounded follow-up pool after the current review queue, rather than republishing
already archived alternates:

- Interstellar vol. 2 selected auditions are now public: Space Odyssey, Red Dwarf,
  Stellar Confrontation and Deep Space. Do not re-add alternate encodings.
...
- Hair and Knuckles: **Technopolis 2021, Agressive and Technologic, A New
  Awakening, Dancing On My Skate**. **Urban Hairbanger** is already public and must
  not be re-added.

These are source-verified leads, not accepted musical matches. Acquire exact files
in small batches, preserve creator licence evidence and hashes, and publish only
after complete decode, loudness/peak measurement, duplicate checks and full-track
listening. Existing catalogue entries such as Meteor Shower, Cosmic Clash, Grave
Rot Requiem and Devoured by Darkness remain excluded from new-count claims.
