...
2. **M8 stream recovery:** desktop delivery is complete in v0.130.0. Merged test-only
   ...
   is exactly based on current main `b55c6d9182d81393d730ec00b093ea55ef632516`.
...
[v0.132.0](https://github.com/mekhovov/revealline/releases/tag/v0.132.0), published
26 September 2026. Its annotated tag dereferences to exact current `main`
`109631e70dc3343a5d0f4338616c2bc95b042f6f`; all nine release assets are present.
Pages now selects v0.132.0 through selector
[PR #592](https://github.com/mekhovov/revealline/pull/592) and exact-merge
[run 36214429148](https://github.com/mekhovov/revealline/actions/runs/36214429148).
Direct public verification confirms `release.json` reports v0.132.0 and the stable
`/app/` launcher and immutable `/releases/v0.132.0/site/game/` route return HTTP 200. The preceding release-trigger
[run 36213375672](https://github.com/mekhovov/revealline/actions/runs/36213375672)
remains retained evidence of the selector mismatch before PR #592.
...
- Local free space is **under 600 MiB** at this checkpoint, below the
  required 1 GiB floor. Local audio acquisition, media derivation, new worktrees and
  full builds are blocked. Continue only hosted operations and bounded metadata or
  documentation work until coordinated cleanup restores the floor; never delete
  user files, frozen releases or evidence.
...
- Unified archive delivery is split into two reviewable changes. Archive
  ...
  adds no public audio yet; it prepares eight exact, nonduplicate metal/action-synth
  candidates using source-page snapshots, native hashes, complete decode, loudness
  evidence and listening-pending derivatives. Its exact artifact and publication
  review remain open. Exact-head archive
...
| M5  | Four third-direction synth auditions are public; runner2088 remains draft; three new rhythmic action-synth candidates are in hosted intake PR #28; Electric Dreams remains the closest accepted reference | Musical fit, full listening and exact admission review; hosted intake and public-archive review remain  | Review 90s Racer Techno, Neon Pulse, Prismatic Light and Future Travel; validate the new Action Synth Track, Darkness Road Climax and Technological Messup artifact; keep PR #23 draft until reconciled; admit only a musically accepted subset | Several hours per comparison round; 1–2 days integration/verification after approval; CI/review waits excluded | Archive [PR #25](https://github.com/mekhovov/revealline-soundtracks-01/pull/25), Pages run 36147468099; draft [PR #23](https://github.com/mekhovov/revealline-soundtracks-01/pull/23); hosted intake [PR #28](https://github.com/mekhovov/revealline-soundtracks-01/pull/28)                                                     | Unreleased in game                                                                                 |
| M6  | Purgatory PR #26 and Reckless PR #27 are public; four Reckless recordings passed technical publication checks; five further high-energy metal candidates are in hosted intake PR #28                      | Full listening, transitions, warnings, Content ID and gameplay acceptance; PR #28 exact hosted artifact | Review the seven Interstellar/Purgatory tracks, then four Reckless tracks; validate Calamity, Nox Venator, Rabidus, Fight for Better Future and The Destoroya; admit only an accepted subset                                                    | Several hours per listening round; 1–2 days integration after approval; CI waits excluded                      | Purgatory [PR #26](https://github.com/mekhovov/revealline-soundtracks-01/pull/26); Reckless [PR #27](https://github.com/mekhovov/revealline-soundtracks-01/pull/27); direct queue [PR #593](https://github.com/mekhovov/revealline/pull/593); new intake [PR #28](https://github.com/mekhovov/revealline-soundtracks-01/pull/28) | Eleven prioritized David KBD candidates public; eight new candidates not yet published or admitted |
...
1. **Metal listening and admission:** the next review set is already public, so the
   ...
   the four Reckless recordings follow. Archive PR #28 separately prepares five
   additional metal candidates: Calamity, Nox Venator, Rabidus, Fight for Better
   Future and The Destoroya. Its hosted artifact must pass before a public audition
   can be assembled. An accepted subset needs 1–2 working days for admission,
...
2. **90s Synth:** review the four public third-direction recordings and resolve the
   conflicting runner2088 draft only if it remains useful. PR #28 also prepares
   Action Synth Track, Darkness Road Climax (Remake) and Technological Messup as a
   more rhythmic action/racing comparison. Allow 1–2 working days for comparison
...
4. **Playback/device closure:** public v0.130 accepts all 140 archive rows and mixed
...
`b55c6d9182d81393d730ec00b093ea55ef632516`. It does not change runtime code or
