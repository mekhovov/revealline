...
| New archive previews     | 172 public archive recordings across 33 collections on two public archives; the immutable 104-recording baseline and its later additions retain separate publication evidence                                                                     | Full listening, taste approval and game admission remain; zero new game admissions                                           |
...
Local free space recovered to about **1.34 GiB** after removing only regenerable
...
8. **Archive scale-out:** archive
   ...
   Archive 02 publishes nine recordings independently, but do not add it to the
...
- Local free space is **about 1.34 GiB** at this checkpoint. Preserve reachable
...
6. **Archive scale-out:** Archive 01 carries 887,503,800 audio bytes. Archive 02 is
   now public with nine recordings, 48,047,386 audio bytes and a verified player. Release
