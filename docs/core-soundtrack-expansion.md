...
[PR #654](https://github.com/mekhovov/revealline/pull/654) remains open and behind
that corrected main. Its earlier exact-head run 36237440597 passed preflight,
focused, build and release-ready, while the full test job was explicitly skipped.
Those earlier results do not qualify a later updated head. The sole publisher must
update and finish v0.132.5 before soundtrack rebases begin.
...
The public archives now expose **177 recording files / 38 collections / 176
distinct compositions**.

Shared local free space briefly recovered above the 1 GiB guard, then concurrent
release work reduced it to approximately **488 MiB**. All further downloads, local
builds and media intake are stopped until coordinated cleanup restores at least 1
GiB. Preserve user changes, frozen releases, worktrees and evidence.
