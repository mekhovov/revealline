...
const FIRST_RETURNS = { ...CROSSWIND_FIRST_RETURNS, ...APEX_FIRST_RETURNS };
...
if (!Object.hasOwn(FIRST_RETURNS, missionId)) throw Error('Choose a Crosswind or Apex mission ID');
if (
