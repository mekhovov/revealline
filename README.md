...
A configurable, Xonix-inspired browser game: leave safe ground, draw a vulnerable cut, close it and reveal a picture. The v0.13.0 release includes 12 campaign maps, seventeen more maps in six installable expansions, four visual worlds, seven gameplay classes and both immediate and grid-buffered steering. Ukrainian FPV Front is the main direction; Ukrainian heritage, 1990s arcade and fictional spend management use the same simulation.
...
The saved [v0.13.0 game](http://127.0.0.1:8767/releases/v0.13.0/site/game/) and [Controller practice](http://127.0.0.1:8767/releases/v0.13.0/site/game/controller-lab/) are available while the workspace server runs. Install Sentinel Relay, Homeward Skies or Equipment Workshop from **Library & saves → Expansion packs**, then choose its Play button. The [frozen browser and offline checks](docs/verification/round-23/frozen-browser.md) and [reproducible archive evidence](docs/verification/round-23/integrity-notes.md) identify this saved build. All sixteen earlier versions, including [v0.12.0](http://127.0.0.1:8767/releases/v0.12.0/site/game/), remain independently playable.
