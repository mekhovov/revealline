...
The latest verified milestone is [v0.35.0](https://mekhovov.github.io/revealline/releases/v0.35.0/site/game/): optional earned-picture stories and Collection replay, with source, frozen, offline and public acceptance. [Its delivery record](docs/verification/round-45/v035-delivery.md) identifies the exact artifact and limits. v0.36 has merged through [PR #12](https://github.com/mekhovov/revealline/pull/12); deployment and public acceptance are pending. This source checkout prepares v0.37 with clearer Collection chapter context, nine Sentinel theme pictures, eight external chapter choices and a read-only production register. Fracture Lines adds three original layout and artwork studies with a source compiler; it is not installed campaign content yet. Source candidates are not publicly delivered until their release gates pass.
