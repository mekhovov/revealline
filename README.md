...
A configurable, Xonix-inspired browser game: leave safe ground, draw a vulnerable cut, close it and reveal a picture. The v0.12.0 working source includes 12 campaign maps, seventeen more maps in six installable expansions, four visual worlds, seven gameplay classes and both immediate and grid-buffered steering. Ukrainian FPV Front is the main direction; Ukrainian heritage, 1990s arcade and fictional spend management use the same simulation.
...
The v0.12.0 working source adds [controller reading](docs/controller-navigation.md) for two regions: mission/result details and the full authored mission brief. Menu Up/Down scroll the selected region; Confirm, Back, Menu or Done exits without starting or resuming a flight. Keyboard and touch retain native scrolling. [Controller practice](docs/controller-practice.md) now offers 18 choices, including a long briefing, and reports requested and actual viewport dimensions with 320 × 640 and 844 × 501 compact options. These are source features; v0.11.0 remains the latest frozen release below. Virtual controls and resized browser views do not establish physical-device compatibility.
...
The saved [v0.11.0 game](http://127.0.0.1:8767/releases/v0.11.0/site/game/) and [Controller practice](http://127.0.0.1:8767/releases/v0.11.0/site/game/controller-lab/) are available while the workspace server runs. Install Sentinel Relay, Homeward Skies or Equipment Workshop from **Library & saves → Expansion packs**, then choose its Play button. The [frozen browser and offline checks](docs/verification/round-21/frozen-browser.md) and [reproducible archive evidence](docs/verification/round-21/integrity-notes.md) identify this saved build. All fourteen earlier versions, including [v0.10.0](http://127.0.0.1:8767/releases/v0.10.0/site/game/), remain independently playable.
