...
**Play:** [current public game](https://mekhovov.github.io/revealline/game/) · [release explorer](https://mekhovov.github.io/revealline/releases/). [Delivery priorities](docs/delivery-priorities.md) is the single current register for player requirements, qualified source, delivery evidence and remaining work. The [detailed delivery history](docs/current-delivery-plan.md) and [production checkpoints](docs/production-plan.md) retain earlier observations; their dated pending/latest wording does not identify today's public edition.
