...
The saved [v0.8.0 game](http://127.0.0.1:8767/releases/v0.8.0/site/game/) and [Controller practice](http://127.0.0.1:8767/releases/v0.8.0/site/game/controller-lab/) are available while the workspace server runs. Install Homeward Skies from **Library & saves → Expansion packs**, then choose **Play Homeward Skies**. Its [frozen browser and offline checks](docs/verification/round-18/frozen-browser.md) and [reproducible archive evidence](docs/verification/round-18/integrity-notes.md) are recorded separately from broader public-release work. All eleven earlier versions, including [v0.7.0](http://127.0.0.1:8767/releases/v0.7.0/site/game/), remain independently playable.
