...
A configurable, Xonix-inspired browser game: leave safe ground, draw a vulnerable cut, close it and reveal a picture. The v0.6.0 source includes 12 campaign maps, thirteen more maps in four installable expansions, four visual worlds, seven gameplay classes and both immediate and grid-buffered steering. Ukrainian FPV Front is the main direction; Ukrainian heritage, 1990s arcade and fictional spend management use the same simulation.
...
The saved [v0.5.0 game](http://127.0.0.1:8767/releases/v0.5.0/site/game/) and [Controller practice](http://127.0.0.1:8767/releases/v0.5.0/site/game/controller-lab/) are available while the workspace server runs. Install Homeward Skies from **Library & saves → Expansion packs**, then choose **Play Homeward Skies**. Its [frozen browser and offline checks](docs/verification/round-15/frozen-browser.md) and [reproducible archive evidence](docs/verification/round-15/integrity-notes.md) are recorded separately from broader public-release work. All eight earlier versions, including [v0.4.1](http://127.0.0.1:8767/releases/v0.4.1/site/game/), remain independently playable.
