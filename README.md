...
The saved [v0.4.1 game](http://127.0.0.1:8767/releases/v0.4.1/site/game/) is available while the workspace server runs. Install Homeward Skies from **Library & saves → Expansion packs**, then choose **Play Homeward Skies**. Its [frozen browser and offline checks](docs/verification/round-14/release-v0.4.1-browser.md) and [reproducible archive evidence](docs/verification/round-14/integrity-v0.4.1-notes.md) are recorded separately from broader public-release work.
