...
For a complete replacement, test against the retained production ledger plus its reviewed successors. Current Studio capacity is 2,048 asset records within the unchanged 4 MiB manifest / 32 MiB transfer / 4 MiB file ceilings. Preserve history and report incompatibility with older Studio count limits rather than trimming originals or raising byte budgets. The complete-collection regression exercises a coordinated 194-slot successor and exact export/import.
