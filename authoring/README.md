...
Guide for v0.19 source authoring · 12 September 2026

The [v0.18 archive](../docs/verification/round-28/v018-preservation.md) includes Pack/Level launch controls and the [gallery-clock repair](../docs/verification/round-28/gallery-clock.md). v0.19 adds verified current/saved attempt exports, described in the [library guide](../docs/library-and-packs.md); it changes no pack, asset, simulation or portable-session format. The [scoped source checks](../docs/verification/round-28/attempt-export.md) and [public-release guide](../docs/public-release.md) identify their evidence and availability.
