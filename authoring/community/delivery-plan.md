...
| -------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- |
| Phases 0–3           | The guide, image and batch generation, mixed video campaigns, `.rlpack`, and installed Solo Custom progression are merged through PR #465. Current generation uses twelve verified threatened variants with enemies and collision obstacles. The combined candidate adds complete mixed-media review cards, explicit include/exclude/reorder/split controls, conflict-safe `.rlsource` recovery of exact images/videos/pairings/posters/ranges, and exact unfinished batch recovery. Built-in-browser AVC+AAC upload/playback, active-playback reload, a 1–5 second range, exact full-video package retention, separate-origin import, explicit unsupported-codec refusal, portrait plus corrupt batch handling, regeneration and same-URL recovery pass. Automated acceptance covers 1/12/50 items, duplicates, portraits, failed items, cancellation and capacity splitting. | Complete the combined PR/release gates. Physical-speaker audio remains follow-up acceptance; missing-original recovery is accepted at deterministic byte-store scope. | Local implementation and built-in-browser workflow complete                              |
...
| Follow-up review     | The implementation is rebased on current `main`. The unfinished-batch recovery head passes 543/543 creator/runtime tests and 43/43 community tests; the focused creator/media matrix passes 127/127 and the batch/orientation slice passes 38/38, with lint and formatting clean. Earlier complete-head evidence includes validation, both dependency audits and the 1,303-file build, and must be rerun on the final exact head. | Rerun complete local gates after the predecessor selector lands, push the rebased exact head, and complete hosted review and CI.                                | 2–4 focused hours plus hosted CI                                                               |
