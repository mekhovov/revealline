...
| Phase 6 Versus       | All twelve generated variants have equal-board replay evidence. Installed exact editions launch in the real two-board host, lock their verified difficulty, award edition-scoped progress/pictures, and support pointer Next. A fresh host restores the exact clear and picture. Async storage failure now retains a durable clear receipt or exposes scoped Retry/Export recovery.                                                 | Complete a physical fresh-browser import/reload acceptance run for installed Versus.                                                             | 0.5 focused acceptance day                                                           |
...
| Follow-up review     | The hardening commits are rebased on current `main`; 524/524 creator/runtime tests, 43/43 service checks, focused Creator Versus/profile coverage 32/32 including nested checks, validation for 1,243 files, localization, lint and formatting pass.                                                                                                                                                                                | Push the exact rebased source and complete hosted review and the assigned v0.141.0 CI build.                                                     | 1–2 hours plus CI/reviewer time                                                      |
| Publication          | PR #564 has the repository-assigned target `v0.141.0`. v0.132.2 is published and publicly selected through merged PR #618; v0.132.1 is retained in Archive90.                                                                                                                                                                                                                                                                       | Complete the v0.141.0 review, freeze, artifact verification and public online/offline acceptance.                                                | 2–4 publisher hours after review                                                     |

## Blockers and concerns

- PR #564 has been allocated `v0.141.0` and is ready for review. Its exact rebased head still needs
  the hosted `release-ready` gate before merge; the old unassigned-slot hold is obsolete.
...
- Installed creator Versus now uses the real two-board host and passes launch, legal completion,
  reward, Cleared, difficulty-lock, pointer Next and fresh-host IndexedDB restoration. Async picture
  persistence failure falls back to an exact durable clear receipt; a complete persistence failure
  leaves scoped Retry/Export recovery visible. A physical fresh-browser import/reload run remains
  required before claiming that transfer path.
