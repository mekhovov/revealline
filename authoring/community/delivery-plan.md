...
| Phase 8 media editor | Silent MP4/WebM input and single-track AVC+AAC MP4 can be physically trimmed or converted to AVC MP4 with bounded Balanced/Compact resize and compression. Exact duration, dimensions, orientation, codec, hash, bitrate, decoded audio windows, A/V endpoints and visual boundaries are verified. The owned AAC fixture passed a real built-in-browser 1–5 second conversion; automated matrix coverage includes Balanced and Compact landscape and portrait transforms, and a real rotated portrait passed both Compact and Balanced in the built-in browser. | Qualify Firefox, Safari, broader formats and physical mobile playback.                                                                                        | Other browsers/devices: 1–2 days when environments are available                              |
