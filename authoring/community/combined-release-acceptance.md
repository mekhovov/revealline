...
The combined source must still merge, receive its publisher-assigned version, pass exact merged
source qualification/freeze, publish the immutable release assets, update the Pages selector in a
separate reviewed publication change, and pass public online/offline byte verification.
