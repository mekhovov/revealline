...
3. **Physical trim** lazy-loads pinned [Mediabunny 1.59.1](https://mediabunny.dev/) only after you
   ...
   both containers to have zero audio tracks.
...
| Physical trim           | One silent AVC/H.264 MP4                                                              | Newly encoded AVC/H.264 MP4 | Mediabunny 1.59.1 loads on request; download remains blocked until changed-byte, fresh decode and exact-byte zero-audio-track checks pass. Audio, WebM and other codecs remain unsupported. |
