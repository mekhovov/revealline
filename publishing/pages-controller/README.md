...
The selector proposes published **v0.61.9** from exact source `6db978db40287151489803e915cb4ecb9ea232ee`. Archive26 retains v0.61.7 and v0.61.8 through its accepted 1,399-file / 626,777,746-byte audit and scoped native practice/Standard picker journeys. It preserves 700 prior rows and changes only the root index. All 89 prior catalog entries, 25 other archive admissions/allocations and earlier evidence remain unchanged. The accepted public baseline stays v0.61.8 until publisher preview, Pages deployment, complete public bytes and the shipped reading/picker journeys pass. See [current-source inputs](evidence/current-v0619/README.md), [archive retention](evidence/archive-26/append-v0618/README.md) and [publication record](delivery/evidence/cross-mode-p05/reading-v0619-publication/README.md).
