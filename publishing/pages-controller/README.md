...
The selector now proposes published **v0.61.6** from exact source `4fd8e2dac4fdc851d0d2bf0b21e77162d9d405c9`. Archive25 preserves v0.61.5 through its accepted 700-file / 313,375,639-byte inventory and scoped native play. This is a new archive with zero prior accepted paths; its original inherited `697` summary value remains alongside the explicit correction. All 86 prior catalog records and all 24 prior admissions/allocations remain unchanged. The accepted public baseline is v0.61.5. This selector requires publisher preview/merge, Pages deployment, the complete public byte audit and the shipped Versus fitting/navigation journey. See [current-source inputs](evidence/current-v0616/README.md), [archive retention](evidence/archive-25/initial-v0615/README.md) and [publication record](delivery/evidence/cross-mode-p08/versus-v0616-publication/README.md).
