...
The selector proposes published **v0.61.21** from source `ef1430174dfd35a9df441233988b8737d0401851`: the Team earned-picture viewer preserves the frozen win and returns to results. Archive27 retains v0.61.9 and v0.61.20 through its accepted 1,399-file / 626,793,669-byte append and scoped keyboard journeys. All 91 prior catalog rows, 26 other archives and earlier evidence remain unchanged. Both retained editions keep their phone focus limitations; the new Team release still needs publisher preview, public deployment, full bytes and its actual reward journey. See [source inputs](evidence/current-v06121/README.md), [Archive27 retention](evidence/archive-27/append-v06120/README.md) and [publication scope](delivery/evidence/cross-mode-p07/team-picture-v06121-publication/README.md).
