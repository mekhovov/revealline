...
The selector now proposes published **v0.61.3** from exact source `58ff1b1da3c5487412e168ce34539866ac2f4970`. Archive23 retains v0.61.1 and v0.61.2 through its accepted 1,393-file / 626,679,348-byte inventory; all 83 prior catalog records and 22 other admissions remain unchanged. The v0.61.2 public baseline is accepted. This selector still requires publisher preview/merge, Pages deployment, complete public audit and an ordinary public runtime/navigation smoke test; the Enemy Workshop Return journey is separately recorded against the source workspace. The [current-source inputs](evidence/current-v0613/README.md), [archive successor admission](evidence/archive-23/append-v0612/README.md) and [publication record](delivery/evidence/cross-mode-p03/enemy-v0613-publication/README.md) retain their scopes.
