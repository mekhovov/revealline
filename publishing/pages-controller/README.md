...
The selector now proposes published **v0.61.2** from exact source `bb5e6e7787bf81232368b96845d716a808c21309`. Archive23 retains v0.61.1 through its accepted 698-file / 313,331,293-byte inventory; all 23 prior admissions and 82 earlier catalog rows are preserved. Source qualification, original upload and a local Team win/continuation passed. This selector still needs its own reviewed PR, Pages deployment, complete public audit and affected public journey. The [current-source inputs](evidence/current-v0612/README.md) and [scoped publication record](delivery/evidence/cross-mode-p08/team-v0612-publication/README.md) retain the evidence and limits.
