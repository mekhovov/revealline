...
The selector now proposes published **v0.61.4** from exact source `d6800fa53d1d9166fe8f310d44aec9c7240b62fc`. Archive24 preserves v0.61.3 through its accepted 698-file / 313,350,864-byte inventory and scoped native play. All 84 prior catalog records and 23 existing admissions remain unchanged. The accepted main baseline is v0.61.3; this selector still requires publisher preview/merge, Pages deployment, complete public audit and the shipped About return journey. The [current-source inputs](evidence/current-v0614/README.md), [archive admission](evidence/archive-24/initial-v0613/README.md) and [publication record](delivery/evidence/cross-mode-p03/about-v0614-publication/README.md) retain those scopes.
