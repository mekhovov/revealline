...
The selector proposes published **v0.64.0** from source `7c9d34f7011a904b9c100f66884a19808666315a`: Team shared wall and player-trail presentation, the complete arena in active short landscape, and explicit picture-retry recovery. Both complete hosted source families passed 6,275 tests across 486 files on Node 20.19.6. Source PR156 merged as `b931cf0e3d899ca937bf5c9a4e883d70fe50d50a` with the same qualified tree. Archive31 retains v0.63.0 through its accepted 711-file / 313,557,913-byte audit and scoped keyboard journey; all 30 prior admissions and 98 existing catalog entries remain unchanged. Pages deployment, complete public bytes and affected Team journeys remain pending. Full P03/P05/P08/P18, Team win → Next, held rescue and physical-device gates remain open. See [Archive31 retention](evidence/archive-31/initial-v0630/README.md) and the [execution register](../../docs/cross-mode-execution.md).
