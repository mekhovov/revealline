...
The selector now proposes published **v0.61.1** from exact source `a7a4e2d7090e2fe9d1843d88b63bc334b95bf61e`. Archive22 retains v0.60.9 and v0.61.0 through its accepted 1,393-file / 626,457,828-byte inventory; Archive21 keeps v0.60.7 and v0.60.8 unchanged. Source qualification and archive acceptance precede this selector preparation; its own Pages deployment, complete public audit and current-edition browser/audio/offline acceptance remain pending. The [current-source inputs](evidence/current-v0611/README.md) and [archive22 successor admission](evidence/archive-22/append-v0610/README.md) retain their original evidence and scope.
