...
The selector proposes published **v0.63.0** from source `3e47f60b9f9b4c5088410536d649ff595b2667eb`: paused Field Details with readable keyboard navigation and focus restoration. Both complete hosted source families passed 6,234 tests across 483 files on Node 20.19.6. Archive30 retains v0.62.0 and v0.62.1 through its accepted 1,408-file / 627,086,405-byte append and scoped keyboard journeys. All 97 prior catalog rows, 29 other archives and earlier evidence remain unchanged. Public deployment and affected Field Details journeys remain pending. See [Archive30 retention](evidence/archive-30/append-v0621/README.md) and the [execution register](../../docs/cross-mode-execution.md).
