...
The selector proposes published **v0.61.20** from source `d51acab59232edc4e7f77ab5df491f2c403de709`. Archive27 retains v0.61.9 through its accepted 701-file / 313,404,982-byte audit and scoped flight/Pause/Workshop return. It is a new archive with zero prior paths. All 90 previous catalog rows, 26 earlier admissions/allocations and original evidence remain unchanged. The v0.61.9 public result remains partial because its portrait-return picker outline clips; v0.61.8 is the prior scoped accepted baseline. The new correction requires publisher preview, protected deployment, full public bytes and shipped Enemy Workshop startup-close/navigation checks. See [source inputs](evidence/current-v06120/README.md), [Archive27 retention](evidence/archive-27/initial-v0619/README.md) and [publication scope](delivery/evidence/cross-mode-p03/enemy-startup-v06120-publication/README.md).
