...
The current selector names v0.56.0 (player library, contextual couch controls and reserve-art authoring), frozen from source `20f017963e6f3875ce6388a198a6fb601e0aea40`. Its exact original published metadata and six-gate source qualification are pinned without changing release assets. Source qualification passed 4,110 tests; complete streamed original verification and the nine uploaded asset identities were reconciled before publication. Current public byte, browser and offline acceptance remain separately scoped post-deployment work. P00 v0.55 acceptance is retained under `delivery/evidence/cross-mode-p00/public-v055/`.
