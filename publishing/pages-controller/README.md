...
The selector proposes published **v0.61.8** from exact source `0ae4330b8a87d332051db112f5e09b7c3cbef9fa`. Archive26 now retains v0.61.7 through its accepted 701-file / 313,387,929-byte audit and scoped native practice, Motion rotation and explorer return. It has zero prior paths. All 88 earlier catalog records and all 25 prior archive admissions/allocations remain unchanged. The accepted public baseline remains v0.61.7 until publisher preview/merge, Pages deployment, full public byte verification and the shipped Standard picker journey pass. See [current-source inputs](evidence/current-v0618/README.md), [archive retention](evidence/archive-26/initial-v0617/README.md) and [publication record](delivery/evidence/cross-mode-p05/picker-v0618-publication/README.md).
