...
import { SOURCE, TREE, VERSION, sha, safePath, validateRows, auditRows, isTransient, loadAuthority } from './audit-main.mjs';
import { inspect, expectedTypes } from './http-engine.mjs';
const home = path.dirname(fileURLToPath(import.meta.url));
assert.equal(SOURCE, 'acc9f265b651017fd268ffd8bbe6989bec614c41');
assert.equal(TREE, '824581317c87a9097097c255f57c11bed153fad0');
assert.equal(VERSION, 'v0.55.0');
