...
assert.equal(SOURCE, 'b7db0134d4ede3452dc90b5d3f7ffb1491a0579b');
assert.equal(TREE, '7cd40e4ef8bf975e7eb2795cdd2669aa18811a57');
assert.equal(VERSION, 'v0.57.0');
const retainedRaw = await readFile(path.join(home, 'retained-catalog.json'));
assert.equal(sha(retainedRaw), RETAINED_CATALOG_SHA);
assert.equal(JSON.parse(retainedRaw).releases.length, 61);
