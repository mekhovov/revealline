#!/usr/bin/env python3
"""Observe the exact main v0.57.1 publication; no writes to GitHub."""
from pathlib import Path
import subprocess,json,datetime,time,hashlib,re
P=Path(__file__).resolve().parent
RUN=34976023839
SHA='9ef75091762cfb9c84b02475ef79913a4476c651'
...
for attempt in range(35):
 ...
 try:
  ...
  if run['status']=='completed':
   ...
   emit({'completed':True,'runId':RUN,'controllerRevision':SHA,'conclusion':run['conclusion'],'scope':'Main v0.57.1 production publication. Public body/browser qualification remains separate.'});break
