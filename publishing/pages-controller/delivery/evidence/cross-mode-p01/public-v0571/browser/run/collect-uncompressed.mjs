import WebSocket from '/Users/oleksandr.mekhovov/.local/share/mise/installs/node/20.19.5/lib/node_modules/difit/node_modules/ws/wrapper.mjs';
...
const socket = new WebSocket(endpoint, { perMessageDeflate: false, maxPayload: 32 * 1024 * 1024 });
