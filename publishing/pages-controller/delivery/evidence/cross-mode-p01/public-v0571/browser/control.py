...
args=['/Users/oleksandr.mekhovov/.local/share/mise/installs/node/20.19.5/bin/agent-browser','--config',str(folder/'agent-browser.json'),'--session','p01-public-v0571',*sys.argv[1:]]
