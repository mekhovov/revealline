...
if(!launch.profile.endsWith('/.cache/cross-mode/p01/v0571/public-browser-preparation/run/profile')||!launch.endpoint.startsWith('ws://127.0.0.1:'))throw Error('Wrong owned browser');
