"""Read every hash-pinned Archive66 HTTP body without persisting payloads.
...
BASE = 'https://mekhovov.github.io/revealline-archive-66/'
COMMIT = None
BINDING = None
INVENTORY_SHA = '1d1eb8d4dff55f46c8a3f322f1479ea96f2f89ee93f5e42b5cc759e8f62d5bc5'
EXPECTED_FILES = 1121
EXPECTED_BYTES = 594897841
SOCKET_TIMEOUT = 25
ATTEMPT_SECONDS = 90
AUDIT_SECONDS = 1800
MAX_ATTEMPTS = 3
CHUNK_BYTES = 65536
# Archive66 only: logs/authority snapshots, never payloads, use a bounded RAM volume.
...
def fetch_once(row, attempt, opener, *, deadline, clock=time.monotonic):
    ...
    try:
        ...
        request = urllib.request.Request(url, headers={
            ...
            'User-Agent': 'RevealLine-archive66-byte-audit/2.0',
        })
...
def main():
    ...
    parser.add_argument('--run', action='store_true', help='Audit the fixed public Archive66 inventory')
