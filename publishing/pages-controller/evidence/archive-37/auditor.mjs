...
assert.equal(run.id,35517891996); assert.equal(run.head_sha,'1bd293f7de06bf02b6c25706b7651f9634bbfc2e');
...
assert.equal(lock.expectedFiles,780);assert.equal(lock.expectedBytes,340018633);
