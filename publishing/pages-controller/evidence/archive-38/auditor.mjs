...
assert.equal(run.id,35531856595); assert.equal(run.head_sha,'760408d1b49e7025662851d45a0bb23afa377ee8');
...
assert.equal(lock.expectedFiles,780);assert.equal(lock.expectedBytes,340012969);
