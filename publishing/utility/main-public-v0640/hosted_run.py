...
def validate_dispatch(raw):
 ...
 b=strict(raw)
 if b.get('format')!='revealline-final-main-public-binding.v1' or b.get('reviewed') is not True or b.get('currentVersion')!='v0.64.0' or b.get('gameSourceRevision')!='7c9d34f7011a904b9c100f66884a19808666315a' or b.get('qualifiedSourceTree')!='db0b7014be960b5e04e41234a802fac9d5930d6d' or not re.fullmatch('[a-f0-9]{40}',b.get('controllerCommit') or ''):raise ValueError('Exact reviewed actual v640 publisher binding required')
 return b
def guard(root):
