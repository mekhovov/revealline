...
assert.equal(SOURCE, '7c9d34f7011a904b9c100f66884a19808666315a');
assert.equal(TREE, 'db0b7014be960b5e04e41234a802fac9d5930d6d');
assert.equal(VERSION, 'v0.64.0');
const retainedRaw = await readFile(path.join(home, 'retained-catalog.json'));
assert.equal(sha(retainedRaw), RETAINED_CATALOG_SHA);
assert.equal(JSON.parse(retainedRaw).releases.length, 98);
