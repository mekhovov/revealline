...
export const SOURCE = 'dae39ba7d4f1a64e309566f9cacca826958e7de2';
export const TREE = 'e003212f771c9c8b71e87c9b913c62f107486e7d';
export const VERSION = 'v0.66.0';
export const RETAINED_CATALOG_SHA = '3aca26948c105bb2f383f417a0947a5af82fa9b8b39f66c5fa854602e9af9251';
...
export function validateAdmissions(configuration, receipt) {
  ...
  for (const a of configuration.admissions) {
    ...
    if (a.id === 'archive-33') {
      require(a.infrastructureCommit === '8e9e15eb55ba98b821e70861a20dc76bb7a761ce' && a.deploymentId === 6547026356,
        'Archive33 must use the accepted v65.0 append.');
...
export function validateModels(binding, models, raws, retainedCatalog) {
  ...
  require(sha(raws.catalog) === catalogSha && catalog.format === 'revealline-frozen-catalog.v1' &&
    ...
    catalog.releases.length === 104 && retainedCatalog.releases.length === 103 &&
