...
assert.equal(SOURCE, 'dae39ba7d4f1a64e309566f9cacca826958e7de2');
assert.equal(TREE, 'e003212f771c9c8b71e87c9b913c62f107486e7d');
assert.equal(VERSION, 'v0.66.0');
const retainedRaw = await readFile(path.join(home, 'retained-catalog.json'));
assert.equal(sha(retainedRaw), RETAINED_CATALOG_SHA);
assert.equal(JSON.parse(retainedRaw).releases.length, 103);
