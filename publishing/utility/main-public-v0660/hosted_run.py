...
def validate_dispatch(raw):
 ...
 b=strict(raw)
 if b.get('format')!='revealline-final-main-public-binding.v1' or b.get('reviewed') is not True or b.get('currentVersion')!='v0.66.0' or b.get('gameSourceRevision')!='dae39ba7d4f1a64e309566f9cacca826958e7de2' or b.get('qualifiedSourceTree')!='e003212f771c9c8b71e87c9b913c62f107486e7d' or not re.fullmatch('[a-f0-9]{40}',b.get('controllerCommit') or ''):raise ValueError('Exact reviewed actual v660 publisher binding required')
 return b
def guard(root):
