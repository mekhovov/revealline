...
assert.equal(SOURCE, '8ae70850db00777eb9afb233ff8a881fc26714f0');
assert.equal(TREE, '3b52b721c2000b316bcc52a3132d011703089888');
assert.equal(VERSION, 'v0.64.1');
const retainedRaw = await readFile(path.join(home, 'retained-catalog.json'));
assert.equal(sha(retainedRaw), RETAINED_CATALOG_SHA);
assert.equal(JSON.parse(retainedRaw).releases.length, 99);
