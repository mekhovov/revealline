...
def validate_dispatch(raw):
 ...
 b=strict(raw)
 if b.get('format')!='revealline-final-main-public-binding.v1' or b.get('reviewed') is not True or b.get('currentVersion')!='v0.64.1' or b.get('gameSourceRevision')!='8ae70850db00777eb9afb233ff8a881fc26714f0' or b.get('qualifiedSourceTree')!='3b52b721c2000b316bcc52a3132d011703089888' or not re.fullmatch('[a-f0-9]{40}',b.get('controllerCommit') or ''):raise ValueError('Exact reviewed actual v641 publisher binding required')
 return b
def guard(root):
