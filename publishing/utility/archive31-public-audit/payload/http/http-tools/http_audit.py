"""Read every hash-pinned Archive31 HTTP body without persisting payloads.
...
COMMIT = None
BINDING = None
INVENTORY_SHA = '285232581d22b530a309eae608a75cb6826bf688bd8604b179b6258f64748da6'
EXPECTED_FILES = 711
EXPECTED_BYTES = 313557913
SOCKET_TIMEOUT = 25
ATTEMPT_SECONDS = 90
AUDIT_SECONDS = 1800
MAX_ATTEMPTS = 3
...
def fetch_once(row, attempt, opener, *, deadline, clock=time.monotonic):
    ...
    try:
        ...
        request = urllib.request.Request(url, headers={
            ...
            'User-Agent': 'RevealLine-archive31-byte-audit/2.0',
        })
...
def main():
    ...
    parser.add_argument('--run', action='store_true', help='Audit the fixed public Archive31 inventory')
