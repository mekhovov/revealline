...
def row(path='releases/v0.63.0/site/game/example.json', body=b'{"ok":true}'):
...
class AuditTests(unittest.TestCase):
    ...
    def test_crosswired_tag_refspec_refuses(self):
        with self.assertRaises(ValueError):
            binding.validate_tag_fetch_cohorts('git fetch origin refs/tags/v0.63.0:refs/tags/v0.61.4', {'releases': [{'version': 'v0.63.0'}]})
