...
PREFIX='repos/mekhovov/revealline-archive-31/'
def endpoint(value):
    allowed={PREFIX+'git/ref/heads/main',PREFIX+'actions/runs/35441173594',PREFIX+'deployments/6540533321',PREFIX+'deployments/6540533321/statuses'}
...
def main(args):
    ...
    request=urllib.request.Request(url,headers={'Accept':'application/vnd.github+json','User-Agent':'RevealLine-archive31-public-authority-audit','X-GitHub-Api-Version':'2022-11-28'})
