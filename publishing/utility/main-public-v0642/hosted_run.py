...
def validate_dispatch(raw):
 ...
 b=strict(raw)
 if b.get('format')!='revealline-final-main-public-binding.v1' or b.get('reviewed') is not True or b.get('currentVersion')!='v0.64.2' or b.get('gameSourceRevision')!='adbfcb94037b8a38d49b9650e7f8a83c7face1db' or b.get('qualifiedSourceTree')!='32369df7260360cc273857b195b2c2c7ca855994' or not re.fullmatch('[a-f0-9]{40}',b.get('controllerCommit') or ''):raise ValueError('Exact reviewed actual v642 publisher binding required')
 return b
def guard(root):
