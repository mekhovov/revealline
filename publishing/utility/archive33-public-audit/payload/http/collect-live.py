...
repo='repos/mekhovov/revealline-archive-33'
...
if not errors:
 ...
 if not(status.get('id')==request['deploymentStatusId'] and status.get('state')=='success' and status.get('environment_url')=='https://mekhovov.github.io/revealline-archive-33/'):errors.append('Live latest status changed')
pins=[]
