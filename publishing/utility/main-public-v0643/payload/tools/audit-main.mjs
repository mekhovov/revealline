...
export const SOURCE = '7a9985ec00168b99a86c1d5db0457343ca18ffae';
export const TREE = '4a5960488f4c19fc8fbd6e784c612b8bdb81596e';
export const VERSION = 'v0.64.3';
export const RETAINED_CATALOG_SHA = '11bf189718f1eb3dc7a0d3b9846847c42c3109bcee583ba66b2ac22ba440d8f5';
...
export function validateAdmissions(configuration, receipt) {
  ...
  for (const a of configuration.admissions) {
    ...
    if (a.id === 'archive-32') {
      require(a.infrastructureCommit === '2ff124892905eda499e7b1fb29729f092a253ecb' && a.deploymentId === 6544867176,
        'Archive32 must use the accepted v64.2 append.');
...
export function validateModels(binding, models, raws, retainedCatalog) {
  ...
  require(sha(raws.catalog) === catalogSha && catalog.format === 'revealline-frozen-catalog.v1' &&
    ...
    catalog.releases.length === 102 && retainedCatalog.releases.length === 101 &&
