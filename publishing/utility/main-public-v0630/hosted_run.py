...
def validate_dispatch(raw):
 ...
 b=strict(raw)
 if b.get('format')!='revealline-final-main-public-binding.v1' or b.get('reviewed') is not True or b.get('currentVersion')!='v0.63.0' or b.get('gameSourceRevision')!='3e47f60b9f9b4c5088410536d649ff595b2667eb' or b.get('qualifiedSourceTree')!='fd0138c0e5f71b8b25368878c1948f5bef14255d' or not re.fullmatch('[a-f0-9]{40}',b.get('controllerCommit') or ''):raise ValueError('Exact reviewed actual v630 publisher binding required')
 return b
def guard(root):
