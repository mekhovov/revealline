...
export const SOURCE = '3e47f60b9f9b4c5088410536d649ff595b2667eb';
export const TREE = 'fd0138c0e5f71b8b25368878c1948f5bef14255d';
export const VERSION = 'v0.63.0';
export const RETAINED_CATALOG_SHA = 'd50ad23442c68a5ea878a526e12f6dd430141e10b3134311ad8c14861e83fedc';
...
export async function execute({ bindingFile, bindingSha, mode, runName }, { home = HOME,
  ...
  const identity = { base: BASE, currentVersion: VERSION, gameSourceRevision: SOURCE, qualifiedSourceTree: TREE,
    ...
    catalogCohorts: authority.catalogCohorts };
  if (mode === 'check') {
