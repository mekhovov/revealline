...
def main(args):
    ...
    request=urllib.request.Request(url,headers={'Accept':'application/vnd.github+json','User-Agent':'RevealLine-archive30-public-authority-audit','X-GitHub-Api-Version':'2022-11-28'})
