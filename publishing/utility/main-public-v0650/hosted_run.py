...
def validate_dispatch(raw):
 ...
 b=strict(raw)
 if b.get('format')!='revealline-final-main-public-binding.v1' or b.get('reviewed') is not True or b.get('currentVersion')!='v0.65.0' or b.get('gameSourceRevision')!='57fdc39aa78683f6de479eb77f810f60e7c6756a' or b.get('qualifiedSourceTree')!='b71a23d6c2474da72ef379793c811e7097b0a156' or not re.fullmatch('[a-f0-9]{40}',b.get('controllerCommit') or ''):raise ValueError('Exact reviewed actual v650 publisher binding required')
 return b
def guard(root):
