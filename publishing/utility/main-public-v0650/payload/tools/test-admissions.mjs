...
assert.throws(() => validateAdmissions(prior, observed(prior)), /Exactly33/);
...
assert.throws(() => validateAdmissions(wrongNew, observed(wrongNew)), /accepted v64.3 preservation/);
