...
def validate_dispatch(raw):
 ...
 b=strict(raw)
 if b.get('format')!='revealline-final-main-public-binding.v1' or b.get('reviewed') is not True or b.get('currentVersion')!='v0.62.1' or b.get('gameSourceRevision')!='9f04273a09dd23d44236c1715d62cfa460171e24' or b.get('qualifiedSourceTree')!='2c35f299f981aba98929ba9ac01addbfe8b48d63' or not re.fullmatch('[a-f0-9]{40}',b.get('controllerCommit') or ''):raise ValueError('Exact reviewed actual v621 publisher binding required')
 return b
def guard(root):
