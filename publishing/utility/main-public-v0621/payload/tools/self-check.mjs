...
assert.equal(SOURCE, '9f04273a09dd23d44236c1715d62cfa460171e24');
assert.equal(TREE, '2c35f299f981aba98929ba9ac01addbfe8b48d63');
assert.equal(VERSION, 'v0.62.1');
const retainedRaw = await readFile(path.join(home, 'retained-catalog.json'));
assert.equal(sha(retainedRaw), RETAINED_CATALOG_SHA);
assert.equal(JSON.parse(retainedRaw).releases.length, 96);
