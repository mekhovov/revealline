...
Run `npm run dev` from the repository root and open [solo play](http://127.0.0.1:8768/game/). The page uses local Phaser 4.2.1 and a browser-independent [simulation core](core/README.md). The preserved [v0.18.0](http://127.0.0.1:8767/releases/v0.18.0/site/game/) build includes 29 maps: 12 base maps and 17 optional maps in six expansions. Homeward Skies and Equipment Workshop offer six original illustrated rewards; the other 23 maps retain procedural scenes. Three optional First Flight lessons are separate, and earlier releases remain independently preserved.

v0.18 introduced Pack and Level selectors and direct campaign launch links, and included the [gallery-clock repair](../docs/verification/round-28/gallery-clock.md). Its [archive verification](../docs/verification/round-28/v018-preservation.md) reproduces every output file. v0.19 source adds source-specific attempt exports and Cancel; read the [save guide](../docs/library-and-packs.md) for Ready, recovery and missing-pack behavior. The [source tests](../docs/verification/round-28/attempt-export.md) and [browser checks](../docs/verification/round-28/attempt-export-browser.md) record their own scopes; the [public-release guide](../docs/public-release.md) identifies frozen and deployed artifacts.

Working v0.20 adds [shared couch controller menus](../docs/couch-controller-navigation.md): either assigned player can claim the menu, choose the race setup, start, pause, resume and play another round. Flight assignments remain separate; keyboard and touch stay available. [Integration checks](../docs/verification/round-29/couch-source.md) and [source browser observations](../docs/verification/round-29/couch-browser.md) describe the checked behavior and device limits. Release packaging and deployment are recorded separately in the public-release guide.
