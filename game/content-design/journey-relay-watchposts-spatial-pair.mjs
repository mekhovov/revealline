...
export const JOURNEY_RELAY_WATCHPOSTS_SPATIAL_DISPOSITIONS = Object.freeze({
  ...
  "watchpost-exchange": Object.freeze({
    ...
    approaches: Object.freeze([
      "northwest-drop-first",
      "southeast-perimeter-first",
    ]),
  }),
});
...
export function createJourneyRelayWatchpostsSpatialPairCandidates({
  artwork = false,
} = {}) {
  ...
  project.name =
    "Whole Journey · Nested relays and watchpost exchange spatial successors";
