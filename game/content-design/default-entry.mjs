...
export function resolveJourneyRequest(
  params,
  { mode = "solo", auxiliary = false } = {},
) {
  if (
    !(params instanceof URLSearchParams) ||
    !Object.hasOwn(DEFAULT_JOURNEY_ROUTES, mode)
  )
    throw new TypeError(
      "Journey entry needs URL parameters and a supported mode.",
    );
