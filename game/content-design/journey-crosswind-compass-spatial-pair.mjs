...
export function createJourneyCrosswindCompassSpatialPairCandidates({ artwork = false } = {}) {
  ...
  project.name = 'Whole Journey · Compass array and outer-loop spatial successors';
