 ...
 * Current fpv90 includes the reviewed v0.132.5 production continuation while
 * these two picture originals remain byte-identical.
 * Exact retained58–89 attempts remain admitted; the separately archived alternate fpv55–57 lineage is not a
 ...
 * explicitly preserved58–89 themes. Current-only callers keep the two-row exports.
 */
