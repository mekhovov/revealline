 ...
 * Current fpv86 includes the reviewed v0.131 production ledger plus the offline
 * audio ownership continuation while these two picture originals remain byte-identical.
 * Exact retained58–85 attempts remain admitted; the separately archived alternate fpv55–57 lineage is not a
 ...
 * explicitly preserved58–85 themes. Current-only callers keep the two-row exports.
 */
