 ...
 * Current fpv69 adds reviewed integrated screen, actor-size and effects metadata
 * while these two picture originals remain byte-identical. Exact retained58–68 attempts
 ...
 * explicitly preserved58–68 themes. Current-only callers keep the two-row exports.
 */
export const COOP_RETAINED_PICTURE_BINDINGS = freezePresentation(
  [58, 59, 60, 61, 62, 63, 64, 65, 66, 67, 68].flatMap((themeRevision) =>
...
export const COOP_HISTORICAL_IMPORT_PICTURE_POLICIES = freezePresentation([
  COOP_HISTORICAL_IMPORT_PICTURE_POLICY,
  ...[58, 59, 60, 61, 62, 63, 64, 65, 66, 67, 68].map((themeRevision) => ({
    ...COOP_HISTORICAL_IMPORT_PICTURE_POLICY,
    themeRevision,
  })),
]);
