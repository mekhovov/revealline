 ...
 * Current fpv88 includes the reviewed v0.132.1 production ledger and soundtrack
 * status continuation while these two picture originals remain byte-identical.
 * Exact retained58–87 attempts remain admitted; the separately archived alternate fpv55–57 lineage is not a
 ...
 * explicitly preserved58–87 themes. Current-only callers keep the two-row exports.
 */
