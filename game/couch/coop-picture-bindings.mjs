 ...
 * Current fpv91 includes the reviewed v0.141.0 managed-media continuation while
 * these two picture originals remain byte-identical.
 * Exact retained58–90 attempts remain admitted; the separately archived alternate fpv55–57 lineage is not a
 ...
 * explicitly preserved58–90 themes. Current-only callers keep the two-row exports.
 */
