 ...
 * Current fpv74 adds reviewed actor-size parity metadata while these two picture
 * originals remain byte-identical. Exact retained58–73 attempts
 ...
 * explicitly preserved58–73 themes. Current-only callers keep the two-row exports.
 */
