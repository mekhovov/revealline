 ...
 */
export const RETAINED_FPV38_PICTURE_BINDINGS = freezePresentation([
  {
 ...
 */
export const RETAINED_FPV38_IMPORT_POLICY = freezePresentation({
...
/** Immutable legacy receipt association, never an uploaded URL or revision range. */
export const RETAINED_FPV38_PRESENTATION = freezePresentation({
