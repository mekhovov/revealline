...
test('history metadata has a finite 5MiB ceiling; transfer, asset and structural limits stay bounded', async () => {
  ...
  assert.equal(LIMITS.assets, 2048);
  ...
  assert.ok(Buffer.byteLength(canonicalJSON(source)) > LIMITS.manifestBytes);
