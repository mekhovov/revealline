...
test('actual Playground child exit keeps the paused run unchanged across re-entry', async (t) => {
  const parentDoc = new Document(),
    parent = new Events();
  parent.location = {
    origin: 'http://localhost',
    href: 'http://localhost/game/playground/?journey=opening',
  };
  ...
  frame.name = 'revealline-playground-preview';
