...
const golden = {
  opening: [
    20768,
    "0dd34097ba74c64cca71139f0656846fab3214fac925abb195acc734c73b1cf9",
  ],
  authored: [
    37368,
    "5ae1f23d12e71adf4dc7c6bdfd6e01fe7dea760b1d75a5b74308984a7be38e63",
  ],
  "whole-originals": [
    223521,
    "feb4b013a8a816e0bc0364fa9dd769a51ea7c92604275657bb418e868f7a0df8",
  ],
  "whole-originals-v2": [
    223548,
  ...
  "whole-spatial-v1": [
    228877,
    "db5d580b22aef1253f7276bb0122540504f55cc4d79af8e344101da57af35467",
  ],
  "whole-spatial-v2": [
    229396,
    "3c20126e35a09324001f61a781a8ae8a684cf421f9de9f5fd5fd7ed1644eab17",
  ],
  "whole-spatial-v3": [
    230328,
    "7e8e35ad9147b75b5040db88411d337c0088ab133f5066ea5ec3eeb5ba092f4c",
  ],
  "whole-spatial-v4": [
    252113,
    "fd5175f63b842b7f71a11cab9e8067f6b7d9d698f026122c83ae14997a91d448",
  ],
  "whole-spatial-v5": [
    252377,
    "74162393aa803207f7e933f4ded83a64a6b223c926aecc5be7bffd113fd959fe",
  ],
  "whole-spatial-v6": [
    254863,
    "8e718fffeed559c5075a4e94d6967d02c266661347ea67392bbb6fe35878769f",
  ],
};
...
for (const id of AUTHORED_JOURNEY_ROUTE_IDS)
  test(`${id}: async and synchronous routes retain exact historical content and fresh ownership`, async () => {
    ...
    for (const route of [first, second, sync]) {
      ...
      assert(
        Object.isFrozen(route) && Object.isFrozen(route.source.missions[0]),
      );
    }
...
const loaderURL = new URL("../content-design/route-loader.mjs", import.meta.url)
  .href;
...
const has = (result, file) =>
  result.modules.some((url) => url.endsWith(`/${file}`));
...
test("selected module failure rejects instead of silently choosing Legacy or another edition", () => {
  ...
  assert.deepEqual(result.output, {
    error: "route-probe: selected module unavailable",
  });
  assert(!has(result, "whole-journey-candidates.mjs"));
  assert(!has(result, "horizon-candidates.mjs"));
});
...
test("all literal lazy imports and shared modules are in the actual game build include", async () => {
  ...
  const files = new Set(
    await collectBuildFiles(root, { entry: config.entry, include: ["game"] }),
  );
