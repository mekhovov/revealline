...
test('registered v15 successor preserves v14 order while v20 owns the current default', async () => {
...
test('Studio retains v14 and v15 while its selector advances to v20', async () => {
