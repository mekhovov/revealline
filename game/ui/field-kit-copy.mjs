import { t, getLocale, normalizeLocale, localizedText, localizedAttribute } from '../i18n/index.mjs';
...
export const FIELD_KIT_KEYS = Object.freeze({
  ...
  "settings.libraryDescription": "interface:manageSavedFlightsGameDataBackupsAndInstalledChaptersIn",
  ...
  "display.standard": "interface:standard",
  ...
  "motion.effectsLocal": "interface:localReducedMotionFreezesAttachmentDetailAndRemovesParticlesMovement",
  ...
  "playground.mapDetailsHelp": "interface:dashedRectanglesMarkSignalZonesDiamondFramedSquaresMarkHangars",
...
export function fieldKitCopy(key, locale = getLocale(), values = {}) {
  return Object.hasOwn(FIELD_KIT_KEYS, key) ? t(FIELD_KIT_KEYS[key], { ...values, lng: normalizeLocale(locale) || 'en' }) : null;
}
export function applyFieldKitCopy(doc) {
  ...
  for (const element of doc.querySelectorAll('[data-field-kit-copy-aria-label]')) {
    ...
    if (Object.hasOwn(FIELD_KIT_KEYS, key)) localizedAttribute(element, 'aria-label', () => fieldKitCopy(key));
  }
}
