...
export const hasTeamRoamers = (level) =>
  [COOP_ROVER_LEVEL_VERSION, COOP_BONUS_LEVEL_VERSION, COOP_IMPACT_LEVEL_VERSION].includes(
    level.version,
  );

export const hasTeamLineImpacts = (level) => level.version === COOP_IMPACT_LEVEL_VERSION;
